Teradata JDBC Driver 20.00.00.56

Part of the Teradata Tools and Utilities 20.00 product suite


System Requirements
-------------------

This version of the Teradata JDBC Driver requires JDK/JRE 8 or later.

This version of the Teradata JDBC Driver does not work with JDK/JRE 7 and earlier.

This version of the Teradata JDBC Driver supports Teradata Analytics Database 16.20, 17.00, 17.10, 17.20, and 20.00.


Installation
------------

Obtain the latest version of the Teradata JDBC Driver from https://downloads.teradata.com/download/connectivity/jdbc-driver

The Teradata JDBC Driver is distributed as a platform-independent jar file. For downloading convenience, the readme and jar file are bundled together and provided in both zip format and tar format.

TeraJDBC__indep_indep.20.00.00.56.zip and TeraJDBC__indep_indep.20.00.00.56.tar both contain the same set of platform-independent files:

  readme.txt               - this file
  terajdbc4.jar            - the Teradata JDBC Driver

Download either the zip file or the tar file, unzip or untar the downloaded file into a directory of your choice, and set your classpath to refer to the jar files required by your application.

Your classpath must include terajdbc4.jar.

Beginning with Teradata JDBC Driver 16.20.00.11, tdgssconfig.jar is no longer part of the Teradata JDBC Driver, and your classpath should not include tdgssconfig.jar.

Your classpath must NOT include any jar files from any previous versions of the Teradata JDBC Driver. We recommend uninstalling any previous version of the Teradata JDBC Driver before downloading and using this version of the Teradata JDBC Driver.


Documentation
-------------

Documentation for the Teradata JDBC Driver is available at https://teradata-docs.s3.amazonaws.com/doc/connectivity/jdbc/reference/current/frameset.html


Change Log
----------

20.00.00.56 - May 6, 2026
* JDBC-192095 connection parameter JWS_AUDIENCE

20.00.00.55 - April 15, 2026
* JDBC-145664 Support the COMMENT ON Returning Comment statement

20.00.00.54 - January 9, 2026
* JDBC-192029 NO_JAVA_PROXY connection parameter
* JDBC-192034 accept port range for OIDC_REDIRECT_PORT connection parameter
* JDBC-192035 add state parameter to Authorization Code Flow

20.00.00.53 - December 4, 2025
* JDBC-192018 allow special characters in username and password

20.00.00.52 - November 6, 2025
* JDBC-191966 connection parameter LOCAL_CATALOG=ON/OFF default OFF
* JDBC-191967 DatabaseMetaData support for OTF Virtual System Dictionary
* JDBC-191968 ResultSetMetaData support for OTF catalog name in StatementInfo parcel

20.00.00.51 - October 8, 2025
* JDBC-191986 connection parameter OIDC_REDIRECT_PORT
* JDBC-191987 token mode

20.00.00.50 - September 23, 2025
* JDBC-191980 exclude from revocation checking last certificate in chain if self-signed

20.00.00.49 - August 4, 2025
* JDBC-191951 OIDC token refresh

20.00.00.47 - July 30, 2025
* JDBC-191975 LOGON_TIMEOUT connection parameter

20.00.00.46 - May 2, 2025
* JDBC-191872 Large update count JDBC 4.2 API methods
* JDBC-191962 command line support for DBCCONS partition
* JDBC-191965 SSLCRCANY=ON now ignores checkServerTrusted error Could not determine revocation status

20.00.00.45 - April 11, 2025
* JDBC-191958 connection parameter HTTPS_RETRY
* JDBC-191959 connection parameter SSLBASE64
* JDBC-191960 query timeout for DBCCONS partition statements

20.00.00.44 - April 2, 2025
* JDBC-191956 SSLNAMEDGROUPS connection parameter
* JDBC-191957 connection parameter OIDC_PROMPT

20.00.00.43 - February 19, 2025
* JDBC-191877 Connection methods createBlob and createClob

20.00.00.42 - February 6, 2025
* JDBC-191952 OAUTH_SCOPES connection parameter for OTF catalog and storage SSO

20.00.00.41 - February 4, 2025
* JDBC-191955 TLS 1.3 Support

20.00.00.40 - January 29, 2025
* JDBC-191906 transmit additional Client Attributes

20.00.00.39 - December 11, 2024
* JDBC-170251 Implement Connection.setClientInfo to set query band

20.00.00.38 - November 23. 2024
* JDBC-191945 OIDC token cache for improved Browser Authentication UX

20.00.00.37 - October 24, 2024
* Add escape function {fn teradata_provide(dhke)}

20.00.00.36 - October 21, 2024
* JDBC-191921 Java TeraGSS LOGMECH=TD2 bypass DHKE for HTTPS connections
* JDBC-191922 Java TeraGSS LOGMECH=JWT bypass DHKE for HTTPS connections
* JDBC-191948 handle Microsoft Entra OIDC Authorization Code Response redirect error parameters
* Improve JDBC Driver command line interface

20.00.00.34 - August 23, 2024
* JDBC-191943 SQLException from message buffer processing
* JDBC-191944 SSLCRCANY=ON handling of BCFIPS 2.0 issues

20.00.00.33 - August 14, 2024
* JDBC-191941 BCFIPS 2.0 interoperability

20.00.00.32 - August 2, 2024
* JDBC-191939 allow FastLoad to NUMBER destination from setObject with targetSqlType DECIMAL

20.00.00.31 - July 31, 2024
* JDBC-191938 CRC client attribute

20.00.00.29 - July 26, 2024
* JDBC-191937 GETURL_CREDENTIALS controls inclusion of SSLTRUSTSTORE_PASSWORD

20.00.00.28 - July 24, 2024
* JDBC-191936 connection parameter ELICIT_FILE_PATH

20.00.00.27 - July 23, 2024
* JDBC-191935 connection parameter SSLCRCANY=OFF (default) or ON

20.00.00.26 - July 18, 2024
* JDBC-191933 Stored Password Protection for HTTPS_PROXY_PASSWORD connection parameter
* JDBC-191934 enable HTTPS connections when TrustManager has no trusted CA issuer certificates

20.00.00.25 - June 10, 2024
* JDBC-191926 OIDC_SSLMODE connection parameter
* JDBC-191928 SSLCRC=ALLOW and PREFER soft fail CRC for VERIFY-CA and VERIFY-FULL
* JDBC-191929 SSLCRC=REQUIRE requires CRC for VERIFY-CA and VERIFY-FULL

20.00.00.24 - May 20, 2024
* JDBC-191925 support proxy-only hostname resolution for Identity Provider

20.00.00.23 - May 16, 2024
* JDBC-191924 additional debug logging for HTTP requests

20.00.00.22 - May 14, 2024
* JDBC-191923 getColumns support for view with UDT column having type name with special characters

20.00.00.21 - May 13, 2024
* JDBC-191920 setObject bind values LocalDate/Time/DateTime OffsetTime/DateTime

20.00.00.20 - April 30, 2024
* JDBC-191913 automatically bind large string values as CLOB
* JDBC-191916 automatically bind large byte array values as BLOB

20.00.00.19 - April 1, 2024
* TDGSS-10459 Java TeraGSS remove MPRAS support and V2R5.x legacy wrap/unwrap

20.00.00.18 - March 22, 2024
* JDBC-191918 accommodate CIBypassSupported property in AuthMech parcel

20.00.00.17 - March 7, 2024
* JDBC-191912 Device Code Flow and Client Credentials Flow
* JDBC-191917 NULL value support for ResultSet getObject with Class type parameter

20.00.00.16 - January 22, 2024
* JDBC-113 ResultSet getObject with Class type parameter
* JDBC-191907 Japanese translation of new JDBC 20.00 error messages

20.00.00.15 - November 3, 2023
* JDBC-191905 additional coverage for FLATTEN connection parameter

20.00.00.14 - October 27, 2023
* JDBC-191903 connection parameters SSLTRUSTSTORE_PASSWORD and SSLTRUSTSTORE_TYPE
* JDBC-191904 allow Unicode characters in LDAP username and password

20.00.00.12 - September 22, 2023
* JDBC-191888 proxy server support
* JDBC-191901 TLS certificate verification for Identity Provider endpoints
* JDBC-191902 request tracking merge counts

20.00.00.11 - July 7, 2023
* JDBC-191892 use loopback IP address for OIDC redirect
* TDGSS-9860 Java TeraGSS interoperability with server-side TDGSS ARM64

20.00.00.10 - May 10, 2023
* JDBC-191873 use OIDC scope from Gateway Config parcel

20.00.00.09 - May 5, 2023
* JDBC-191891 avoid IllegalArgumentException: Last character in replacement string

20.00.00.08 - May 5, 2023
* JDBC-191890 connection parameter SSLDEBUG=ON sets System property javax.net.debug=all

20.00.00.07 - May 3, 2023
* JDBC-191889 Escape functions teradata_provide(governed) and teradata_provide(uses_check_workload)

20.00.00.06 - March 3, 2023
* JDBC-191879 Escape function teradata_provide(request_scope_catalog_json)

20.00.00.02 - January 31, 2023
* JDBC-191874 TLS certificate revocation checking with CRL
* JDBC-191875 TLS certificate revocation checking with OCSP (not OCSP stapling)

20.00.00.00 - January 4, 2023
* requires JDK/JRE 8 or later

17.20.00.16 - July 1, 2025
* JDBC-191973 Backport to JDBC Driver 17.20 accommodate CIBypassSupported property in AuthMech parcel

17.20.00.15 - December 8, 2022
* JDBC-191878 read WebSocket frame more efficiently

17.20.00.13 - October 19, 2022
* JDBC-191861 case-insensitive VERIFY-FULL

17.20.00.12 - October 11, 2022
* JDBC-191860 LOGMECH=BROWSER support for UTF16 session charset

17.20.00.10 - October 7, 2022
* JDBC-191767 DATABASE connection parameter value quoting
* JDBC-191859 NEW_PASSWORD user and password quoting

17.20.00.09 - August 30, 2022
...
15.10.00.23 - July 20, 2016
* JDBC-176193 Support DATASET data type

15.10.00.22 - July 6, 2016
...
14.10.00.27 - January 28, 2014
* JDBC-162376 Support JSON data type

14.10.00.26 - January 17, 2014
