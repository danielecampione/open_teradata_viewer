 ...
 * type (the column name discoverer appropriate to the MySQL syntax).
 * 
 * @author D. Campione
 *
 */
public class MySqlColumnsNameDiscovererHandler extends ColumnsNameDiscovererHandlerFactoryMethod {

    @Override
    public IColumnsNameDiscovererElement newElement() {
        return new MySqlColumnsNameDiscoverer();
    }
