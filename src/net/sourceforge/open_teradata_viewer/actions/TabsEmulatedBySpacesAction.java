 ...
 * 
 */
public class TabsEmulatedBySpacesAction extends CustomAction {
    ...
    public void actionPerformed(final ActionEvent e) {
        // The "tabs emulated by spaces" process can be performed altough other
    ...
    protected void performThreaded(ActionEvent e) throws Exception {
        SyntaxTextArea textArea = ApplicationFrame.getInstance()
                .getTextComponent();
        textArea.setTabsEmulated(!textArea.getTabsEmulated());
    }
}