...
public class ConnectAction extends CustomAction {
    ...
    protected void performThreaded(ActionEvent e) throws Exception {
        ...
        Object value = Dialog.show("Connections", new JScrollPane(list),
                Dialog.PLAIN_MESSAGE, new Object[] { "Connect", "Cancel",
                        "Add", "Edit", "Duplicate", "Delete" }, "Connect");
    ...
    private ConnectionData newConnectionWizard() throws IOException {
        ...
        Object db = Dialog.show("New Connection", "Choose database",
                Dialog.PLAIN_MESSAGE, new Object[] { "Teradata", "Oracle",
                        "DB2", "MySQL", "SQLite", "HSQLDB", "H2", "Derby",
                        "SQL Server", "Other" }, null);
        if ("Teradata".equals(db)) {
            ...
            connectionData
                    .setUrl(String
                            .format("jdbc:teradata://%s/database=%s,TMODE=ANSI,DBS_PORT=1025,CHARSET=UTF8,LOGMECH=LDAP,LOGDATA=<user>@@<password>",
            ...
            String databaseName = checkString(JOptionPane
                    .showInputDialog("Database name"));
            String portNumber = checkString(JOptionPane.showInputDialog(
                    "Port number", "50000"));
            connectionData.setName(databaseName);
            ...
            String fileName = checkString(JOptionPane.showInputDialog(
                    "File name", new File("/sqlite.db").getCanonicalPath()));
            ...
            connectionData.setUrl(String.format(
                    "jdbc:jtds:sqlserver://%s:1433/%s", serverName,
                    databaseName));
        }
    ...
    private boolean editConnection(ConnectionData connectionData, boolean nested)
        ...
        if (Dialog.OK_OPTION == i && connectionData.getName().trim().isEmpty()) {
            Dialog.show("Empty name", "Why would you want an empty name?",
                    ...
                    new Object[] { "OK, I'm sorry, I will give it a name." },
                    null);
