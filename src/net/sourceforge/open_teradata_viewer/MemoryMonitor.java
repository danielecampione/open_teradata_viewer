...
public class MemoryMonitor extends JPanel {
    ...
    private static final long serialVersionUID = -8878164395946067728L;

    public static JCheckBox dateStampCB = new JCheckBox("Output Date Stamp");
    public Surface surf;
    public static final int MIN_WIDTH = 156;
    public static final int MIN_HEIGHT = 56;
    JPanel controls;
    boolean doControls;
    private JTextField tf;
    public static final int DEFAULT_SLEEP_AMOUNT = 1000;
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if ((doControls = !doControls)) {
                    ...
                    try {
                        ...
                        if (surf.sleepAmount < 0) {
                            throw new NumberFormatException();
                        }
                    } catch (NumberFormatException nfe) {
                        tf.setText(""
                                + (surf.sleepAmount = DEFAULT_SLEEP_AMOUNT));
                    }
                    surf.start();
                    add(surf);
                }
    ...
    public void setSleepAmount(long sleepAmount) {
        surf.sleepAmount = sleepAmount;
        tf.setText("" + sleepAmount);
    }
    /**
     * 
     * 
    ...
    public class Surface extends JPanel implements Runnable {
        ...
        private static final long serialVersionUID = -8431225511452281220L;
            ...
            while (thread == me && isShowing()) {
                ...
                if (MemoryMonitor.dateStampCB.isSelected()) {
                    ApplicationFrame.getInstance().changeLog
                            .append(new Date().toString() + " " + usedStr
                                    + "\n");
                }
            }
            thread = null;
