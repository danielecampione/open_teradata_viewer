...
public class GraphicViewerNode extends GraphicViewerArea
    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerNode",
                    domelement);
    ...
    private void a(ArrayList arraylist, GraphicViewerObject graphicviewerobject) {
        if (graphicviewerobject != null
