...
public class GraphicViewerArea extends GraphicViewerObject
    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        ...
        if (domdoc.GraphicViewerXMLOutputEnabled())
            domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerArea",
                    domelement);
        ...
        GraphicViewerListPosition graphicviewerlistposition = getFirstObjectPos();
        DomElement domelement2 = domelement1;
    ...
    public DomNode SVGReadObject(DomDoc domdoc,
            ...
            DomElement domelement1) {
        if (domelement1 != null) {
            DomElement domelement2 = domelement1.getNextSiblingElement();
    ...
    private static final int cF = 1901;
