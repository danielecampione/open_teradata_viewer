    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerObject",
                    domelement);
        ...
        if (domdoc.SVGOutputEnabled() && getToolTipText() != null) {
            DomElement domelement2 = domdoc.createElement("title");
            domelement2.setAttribute("content", "structured text");
            domelement.appendChild(domelement2);
            DomText domtext = domdoc.createText(getToolTipText());
            ...
            case 10 : // '\n'
                ...
                if (obj != null) {
                    GraphicViewerListPosition graphicviewerlistposition = ((GraphicViewerObjectCollection) (obj))
                            .findObject(this);
                    GraphicViewerListPosition graphicviewerlistposition1 = ((GraphicViewerObjectCollection) (obj))
                            .getNextObjectPos(graphicviewerlistposition);
                    GraphicViewerObject graphicviewerobject = ((GraphicViewerObjectCollection) (obj))
