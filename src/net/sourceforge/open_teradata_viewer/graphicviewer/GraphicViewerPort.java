...
public class GraphicViewerPort extends GraphicViewerDrawable
    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerPort",
                    domelement);
        ...
        if (domdoc.SVGOutputEnabled()) {
            ...
            switch (dw) {
                ...
                case 3 : // '\003'
                    ...
                    DomElement domelement3 = domdoc.createElement("path");
                ...
                case 4 : // '\004'
                    DomElement domelement4 = domdoc.createElement("rect");
                    domelement4
                ...
                case 5 : // '\005'
                    ...
                    ai[3] = rectangle.x;
                    ai1[3] = ai1[1];
                    DomElement domelement5 = domdoc.createElement("path");
                ...
                default :
                    ...
                    int k = getWidth() / 2;
                    int l = getHeight() / 2;
                    DomElement domelement6 = domdoc.createElement("ellipse");
    ...
    @SuppressWarnings("unused")
    private static final int dy = 0x10000;
    @SuppressWarnings("unused")
    private static final int du = 0x20000;
    @SuppressWarnings("unused")
    private static final int dC = 0x40000;
    @SuppressWarnings("unused")
    private static final int dH = 0x80000;
