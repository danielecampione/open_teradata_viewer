...
public class GraphicViewerStroke extends GraphicViewerDrawable {
    ...
    static class ArrowInfo implements Serializable {
        ...
        public void SVGWriteGraphicViewerElementAttributes(DomElement domelement) {
        ...
        public void SVGReadGraphicViewerElementAttributes(DomElement domelement) {
    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerStroke",
                    domelement);
    ...
    @SuppressWarnings("unused")
    private static final double ci = 10D;
    @SuppressWarnings("unused")
    private static final double ce = 8D;
    @SuppressWarnings("unused")
    private static final double cl = 8D;
    @SuppressWarnings("unused")
    private static final int ch = 32768;
    @SuppressWarnings("unused")
    private static final int cc = 16384;
    @SuppressWarnings("unused")
