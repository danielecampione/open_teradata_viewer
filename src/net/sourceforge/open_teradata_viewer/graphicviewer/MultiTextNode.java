...
public class MultiTextNode extends GraphicViewerNode {
    ...
    public void layoutChildren(GraphicViewerObject graphicviewerobject) {
        ...
        int i = 0;
        if (getTopPort() != null)
            i = getTopPort().getHeight();
        @SuppressWarnings("unused")
        int j = 0;
        if (getBottomPort() != null)
            j = getBottomPort().getHeight();
        @SuppressWarnings("unused")
        int k = getMaxPortWidth(true);
        @SuppressWarnings("unused")
        int l = getMaxPortWidth(false);
        int i1 = getItemWidth();
    ...
    protected void layoutItem(int i, int j, int k, int l, int i1, int j1) {
        ...
        @SuppressWarnings("unused")
        int l1 = graphicviewerdrawable.getTop();
    ...
    public void paint(Graphics2D graphics2d, GraphicViewerView graphicviewerview) {
        ...
        @SuppressWarnings("unused")
        int i1 = graphicviewerdrawable.getHeight();
        Insets insets = getInsets();
        @SuppressWarnings("unused")
    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.MultiTextNode",
                    domelement);
