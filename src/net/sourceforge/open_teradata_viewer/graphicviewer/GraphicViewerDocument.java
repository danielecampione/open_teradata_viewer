...
import net.sourceforge.open_teradata_viewer.graphicviewer.svg.DefaultDocument;
...
public class GraphicViewerDocument
    ...
    public Rectangle computeBounds() {
        return computeBounds(((GraphicViewerObjectSimpleCollection) (this)));
    }
    ...
    public GraphicViewerDocumentListener[] getDocumentListeners() {
        if (eX == null)
            return new GraphicViewerDocumentListener[0];
        Object aobj[] = eX.toArray();
        GraphicViewerDocumentListener agraphicviewerdocumentlistener[] = new GraphicViewerDocumentListener[aobj.length];
        for (int i = 0; i < aobj.length; i++)
            agraphicviewerdocumentlistener[i] = (GraphicViewerDocumentListener) aobj[i];
    ...
    void a(int i, int j, Object obj, int k, Object obj1) {
        ...
        e5 = null;
        ArrayList arraylist = eX;
        if (arraylist != null) {
            int l = arraylist.size();
            for (int i1 = 0; i1 < l; i1++) {
                GraphicViewerDocumentListener graphicviewerdocumentlistener = (GraphicViewerDocumentListener) arraylist
                        .get(i1);
    ...
    public GraphicViewerIdentifiablePart findPart(int i) {
        if (eS != null)
            return (GraphicViewerIdentifiablePart) eS.get(new Integer(i));
        else
            return null;
    }

    @SuppressWarnings({"unchecked", "rawtypes"})
    void a(GraphicViewerIdentifiablePart graphicvieweridentifiablepart) {
        if (eS == null)
            eS = new HashMap(1000);
    ...
    void _mthif(GraphicViewerIdentifiablePart graphicvieweridentifiablepart) {
        if (eS != null)
    ...
    void _mthcase(GraphicViewerObject graphicviewerobject) {
        if (graphicviewerobject instanceof GraphicViewerIdentifiablePart) {
            GraphicViewerIdentifiablePart graphicvieweridentifiablepart = (GraphicViewerIdentifiablePart) graphicviewerobject;
    ...
    void a(GraphicViewerDocumentChangedEdit graphicviewerdocumentchangededit) {
        ...
        switch (graphicviewerdocumentchangededit.getOldValueInt()) {
            ...
            case 2 : // '\002'
                GraphicViewerObjectCollection graphicviewerobjectcollection = (GraphicViewerObjectCollection) graphicviewerdocumentchangededit
                        .getOldValue();
            ...
            case 6 : // '\006'
                GraphicViewerObjectCollection graphicviewerobjectcollection1 = (GraphicViewerObjectCollection) graphicviewerdocumentchangededit
                        .getOldValue();
            ...
            case 4 : // '\004'
                ...
                if (obj1 == null)
                    break;
                GraphicViewerListPosition graphicviewerlistposition1 = ((GraphicViewerObjectCollection) (obj1))
                ...
                if (graphicviewerlistposition1 != null) {
                    if (obj1 instanceof GraphicViewerArea)
                        ...
                        ((GraphicViewerObjectCollection) (obj1))
            ...
            case 0 : // '\0'
                Object aobj[] = (Object[]) graphicviewerdocumentchangededit
                        .getOldValue();
                GraphicViewerObjectCollection graphicviewerobjectcollection2 = (GraphicViewerObjectCollection) aobj[0];
                if (aobj[1] != null) {
    ...
    public static DataFlavor getStandardDataFlavor() {
        if (e4 == null)
            try {
                e4 = new DataFlavor(
                        Class.forName("net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerSelection"),
    ...
    public GraphicViewerCopyEnvironment createDefaultCopyEnvironment() {
    ...
    public GraphicViewerObject addCopy(GraphicViewerObject graphicviewerobject,
        ...
        GraphicViewerCopyEnvironment graphicviewercopyenvironment = copyFromCollection(
                graphicviewercollection, point1, null);
        return (GraphicViewerObject) graphicviewercopyenvironment
                .get(graphicviewerobject);
    }

    public GraphicViewerCopyEnvironment copyFromCollection(
            GraphicViewerObjectSimpleCollection graphicviewerobjectsimplecollection) {
    ...
    public void SVGWriteObject(DomDoc domdoc, DomElement domelement) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerDocument",
                    domelement);
    ...
    public void SVGWriteLayer(DomDoc domdoc, DomElement domelement,
            GraphicViewerLayer graphicviewerlayer) {
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            DomElement domelement1 = domdoc.createGraphicViewerClassElement(
                    "net.sourceforge.open_teradata_viewer.graphicviewer.GraphicViewerLayer",
                    domelement);
    ...
    public DomNode SVGReadLayer(DomDoc domdoc,
            GraphicViewerDocument graphicviewerdocument, DomElement domelement,
            DomElement domelement1, GraphicViewerLayer graphicviewerlayer) {
        if (domelement1 != null) {
    ...
    @SuppressWarnings("rawtypes")
    private transient ArrayList eX;
