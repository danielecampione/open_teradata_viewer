...
public class DirectoryChooser extends JTree {
    ...
    private static final long serialVersionUID = 3406393067256419868L;
    ...
    private static class DirNode extends DynamicUtilTreeNode {
        ...
        private static final long serialVersionUID = 7509917066369030072L;
    ...
    private static class DirRenderer extends DefaultTreeCellRenderer {
        ...
        private static final long serialVersionUID = -1714494047483546280L;
        ...
        public Component getTreeCellRendererComponent(JTree tree, Object value,
            ...
            return super.getTreeCellRendererComponent(tree,
                    FILE_SYSTEM_VIEW.getSystemDisplayName(file), sel, expanded,
                    leaf, row, hasFocus);
        }
    }
}
