 ...
 * 
 */
public interface IHelpFileWrappers {

    void setFileWrapperFactory(IFileWrapperFactory factory);

    void setHelpFiles(HelpFiles files);

    IFileWrapper getQuickStartGuideFile();
