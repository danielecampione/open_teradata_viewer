...
public class UnicodeWriter extends Writer {
     ...
     * files written out as UTF-8 will not have a BOM written for them.
     * Otherwise (even if the property is not set), UTF-8 files will have a BOM
     * written.
     */
    ...
    private void init(OutputStream out, String encoding)
        ...
        // write out the BOM; "UTF-16LE", "UTF-16BE", "UTF-32", "UTF-32LE" and
        // "UTF-32BE" don't
