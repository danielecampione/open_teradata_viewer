 ...
 * StatusBarPanel} and they must be added via the
...
public class StatusBar extends StatusBarPanel
    ...
    public static final String STYLE_PROPERTY = "ApplicationStatusBarPanel.style";
     ...
     */
    public void addStatusBarComponent(StatusBarPanel panel, int index,
        ...
        if (oldStyle != style) {
            ...
            switch (style) {
                ...
                case WINDOWS_XP_STYLE :
                    ...
                    c.fill = GridBagConstraints.BOTH;
                    c.weightx = 0.0;
                    JPanel filler = new StatusBarPanel();
