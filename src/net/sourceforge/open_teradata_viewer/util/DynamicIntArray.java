...
public class DynamicIntArray implements Serializable {
    ...
    private static final long serialVersionUID = -1135940363026215019L;

    /** The actual data. */
    private int[] data;

    /**
     * The number of values in the array. Note that this is NOT the capacity of
     * the array; rather, <code>size &lt;= capacity</code>.
     */
    private int size;
     ...
     * <code>DynamicIntArray</code> will have an initial capacity of 110% the
     * size of the array.
     *
     ...
     * object at the specified location. Shifts the <code>int</code> currently
     * at that position (if any) and any subsequent <code>int</code>s to the
     ...
     * array. Shifts the <code>int</code> currently at that position (if any)
     * and any subsequent <code>int</code>s to the right (adds one to their
     * indices).
     *
     * @param index The index at which the specified integer is to be inserted.
    ...
    /**
     * Returns whether this array contains a given integer. This method performs
     * a linear search, so it is not optimized for performance.
     *
    ...
    /**
     * Returns the <code>int</code> at the specified position in this array
     * object, without doing any bounds checking. You really should use {@link
     * #get(int)} instead of this method.
     *
     * @param index The index of the <code>int</code> to return.
     * @return The <code>int</code> at the specified position in this array.
     */
     ...
     *         <code>toIndex</code> is less than zero or greater than or equal
     ...
     *         or greater than or equal to <code>getSize()</code>.
     */
    ...
    /**
     * Sets the <code>int</code> value at the specified position in this array
     * object, without doing any bounds checking. You should use {@link
     * #set(int, int)} instead of this method.
     *
     * @param index The index of the <code>int</code> to set.
     * @param value The value to set it to.
     */
     ...
     * error-checking code, so that callers (e.g. {@link #get} and {@link #set})
     * can be both small enough to be inlined, as well as not usually make any
     * expensive method calls (since their callers will usually not pass illegal
     * arguments to them).
     *
    ...
    /**
     * Throws an exception. This method isolates error-handling code from the
     * error-checking code, so that callers can be both small enough to be
