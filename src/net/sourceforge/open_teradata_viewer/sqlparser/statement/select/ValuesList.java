...
public class ValuesList implements IFromItem {
    ...
    public ValuesList(MultiExpressionList multexpressionList) {
        this.multexpressionList = multexpressionList;
    }
    ...
    public MultiExpressionList getMultiExpressionList() {
        return multexpressionList;
    }

    public void setMultiExpressionList(MultiExpressionList multexpressionList) {
        this.multexpressionList = multexpressionList;
    }
    ...
    public String toString() {
        ...
        for (Iterator<ExpressionList> it = getMultiExpressionList()
            ...
            b.append(PlainSelect.getStringList(it.next().getExpressions(),
                    true, !isNoBrackets()));
            if (it.hasNext()) {
                b.append(", ");
            }
