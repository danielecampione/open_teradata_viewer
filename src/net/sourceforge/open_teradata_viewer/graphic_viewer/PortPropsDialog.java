...
public class PortPropsDialog extends JDialog {
    ...
    void jbInit() throws Exception {
        ...
        jLabel1.setText(LanguageManager.getInstance().getString("label.port_style"));
        jLabel1.setBounds(new Rectangle(27, 295, 55, 15));
        portStyleComboBox.setBounds(new Rectangle(79, 292, 88, 21));
        validDestinationCheckBox.setText(LanguageManager.getInstance().getString("checkbox.valid_destination"));
        validDestinationCheckBox.setBounds(new Rectangle(34, 320, 117, 23));
        validSourceCheckBox.setText(LanguageManager.getInstance().getString("checkbox.valid_source"));
        validSourceCheckBox.setBounds(new Rectangle(34, 343, 97, 23));
        validDuplicateLinksCheckBox.setText(LanguageManager.getInstance().getString("checkbox.valid_duplicate_links"));
        validDuplicateLinksCheckBox.setBounds(new Rectangle(34, 365, 126, 23));
        validSelfNodeCheckBox.setText(LanguageManager.getInstance().getString("checkbox.valid_self_node"));
        ...
        jLabel2.setText(LanguageManager.getInstance().getString("label.from_spot"));
        jLabel2.setBounds(new Rectangle(177, 295, 55, 15));
        jLabel3.setText(LanguageManager.getInstance().getString("label.to_spot"));
        jLabel3.setBounds(new Rectangle(177, 324, 73, 15));
        jLabel4.setText(LanguageManager.getInstance().getString("label.default_paint_greek_scale"));
        jLabel4.setBounds(new Rectangle(177, 347, 134, 15));
        jLabel5.setBounds(new Rectangle(177, 369, 134, 15));
        jLabel5.setText(LanguageManager.getInstance().getString("label.default_paint_nothing_scale"));
        jLabel6.setText(LanguageManager.getInstance().getString("label.end_segment_length"));
        ...
        label3.setText(LanguageManager.getInstance().getString("label.y"));
        label3.setHorizontalAlignment(JLabel.RIGHT);
        label3.setBounds(new Rectangle(24, 60, 48, 24));
        visibleBox.setText(LanguageManager.getInstance().getString("checkbox.visible"));
        visibleBox.setBounds(new Rectangle(24, 96, 72, 24));
        selectableBox.setText(LanguageManager.getInstance().getString("checkbox.selectable"));
        selectableBox.setBounds(new Rectangle(24, 120, 84, 24));
        resizableBox.setText(LanguageManager.getInstance().getString("checkbox.resizable"));
        resizableBox.setBounds(new Rectangle(24, 144, 84, 24));
        draggableBox.setText(LanguageManager.getInstance().getString("checkbox.draggable"));
        draggableBox.setBounds(new Rectangle(24, 168, 84, 24));
        label4.setText(LanguageManager.getInstance().getString("label.width"));
        label4.setHorizontalAlignment(JLabel.RIGHT);
        label4.setBounds(new Rectangle(132, 36, 48, 24));
        widthField.setBounds(new Rectangle(192, 36, 36, 24));
        brushColorButton.setText(LanguageManager.getInstance().getString("button.fill_color"));
        brushColorButton.setBackground(java.awt.Color.lightGray);
        brushColorButton.setBounds(new Rectangle(283, 258, 108, 24));
        solidBrushBox.setText(LanguageManager.getInstance().getString("checkbox.solid_brush"));
        solidBrushBox.setBackground(java.awt.Color.lightGray);
        solidBrushBox.setBounds(new Rectangle(288, 126, 108, 24));
        penColorButton.setText(LanguageManager.getInstance().getString("button.pen_color"));
        penColorButton.setBackground(java.awt.Color.lightGray);
        penColorButton.setBounds(new Rectangle(127, 258, 108, 24));
        classNameLabel.setText(LanguageManager.getInstance().getString("label.class_name"));
        classNameLabel.setBounds(new Rectangle(26, 4, 364, 24));
        solidPenButton.setText(LanguageManager.getInstance().getString("radio.solid_line_pen"));
        ...
        dashedPenButton.setText(LanguageManager.getInstance().getString("radio.dashed_line_pen"));
        ...
        dottedPenButton.setText(LanguageManager.getInstance().getString("radio.dotted_line_pen"));
        ...
        dashdotPenButton.setText(LanguageManager.getInstance().getString("radio.dash_dot_pen"));
        ...
        dashdotdotPenButton.setText(LanguageManager.getInstance().getString("radio.dash_dot_dot_pen"));
        ...
        customPenButton.setText(LanguageManager.getInstance().getString("radio.custom_pen"));
        ...
        noPenButton.setText(LanguageManager.getInstance().getString("radio.no_pen"));
        ...
        label5.setText(LanguageManager.getInstance().getString("label.pen_properties"));
        label5.setFont(new Font("Dialog", Font.ITALIC, 12));
        label5.setBounds(new Rectangle(27, 1, 95, 23));
        label6.setText(LanguageManager.getInstance().getString("label.pen_width"));
        ...
        label8.setText(LanguageManager.getInstance().getString("label.brush_properties"));
