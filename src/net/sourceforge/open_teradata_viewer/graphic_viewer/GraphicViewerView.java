...
public class GraphicViewerView extends JComponent
    ...
    private final void _mthif(GraphicViewerDocument graphicviewerdocument) {
        ...
        aM = null;
        aL = new Point(0, 0);
        aU = new ArrayList<GraphicViewerObject>();
        az = null;
        am = null;
        aT = null;
        L = null;
        ...
        a7 = new Point(0, 0);
        ar = null;
        aA = new ArrayList<GraphicViewerControl>();
        aq = false;
        I = new Dimension();
        A = new Point(0, 0);
    ...
    private void a(GraphicViewerObject graphicviewerobject,
            Rectangle rectangle, ArrayList<GraphicViewerObject> arraylist) {
    ...
    public void addViewListener(
        ...
        if (ay == null)
            ay = new ArrayList<IGraphicViewerViewListener>();
    ...
    void a(GraphicViewerViewEvent graphicviewerviewevent) {
        if (ay != null) {
            for (int i = 0; i < ay.size(); i++) {
                IGraphicViewerViewListener graphicviewerviewlistener = (IGraphicViewerViewListener) ay
                        .get(i);
    ...
    public void moveSelection(GraphicViewerSelection graphicviewerselection,
        ...
        if (i1 == 1 || i1 == 2 && l == 3)
            flag = true;
        ArrayList<GraphicViewerObject> arraylist = computeEffectiveSelection(
                graphicviewerselection, true, true);
        Point point = new Point(0, 0);
        int j1 = getGridSpot();
    ...
    public ArrayList<GraphicViewerObject> computeEffectiveSelection(
    ...
    public ArrayList<GraphicViewerObject> computeEffectiveSelection(
        ...
        HashMap<GraphicViewerObject, GraphicViewerObject> hashmap = new HashMap<GraphicViewerObject, GraphicViewerObject>();
        ArrayList<GraphicViewerObject> arraylist = null;
    ...
    private void a(GraphicViewerObject graphicviewerobject,
            HashMap<GraphicViewerObject, GraphicViewerObject> hashmap,
    ...
    public void copySelection(GraphicViewerSelection graphicviewerselection,
        ...
        ArrayList<GraphicViewerObject> arraylist = computeEffectiveSelection(
                graphicviewerselection, false, false);
        ...
        ArrayList<GraphicViewerObject> arraylist1 = aU;
        arraylist1.clear();
        Iterator<?> iterator = graphicviewercopyenvironment.entrySet()
                .iterator();
        do {
            if (!iterator.hasNext())
                break;
    ...
    public void copyToClipboard(Clipboard clipboard) {
        ...
        if (graphicviewerdocument != null)
            try {
                Class<? extends GraphicViewerDocument> class1 = graphicviewerdocument
                        .getClass();
        ...
        if (droptargetdropevent.isDataFlavorSupported(dataflavor)
            ...
            if (graphicviewerlistposition != null) {
                ...
                if (graphicviewerdocument != null) {
                    ...
                    graphicviewerselection.clearSelection();
                    fireUpdate(37, 0, null);
                    Iterator<?> iterator = graphicviewercopyenvironment1
                            .values().iterator();
                    do {
                        if (!iterator.hasNext())
                            break;
    ...
    private transient ArrayList<GraphicViewerObject> aU;
    private boolean B;
    ...
    private transient ArrayList<GraphicViewerControl> aA;
    ...
    private transient ArrayList<IGraphicViewerViewListener> ay;
