...
public class ImagePropsDialog extends JDialog {
    ...
    void jbInit() throws Exception {
        ...
        OKButton.setText(LanguageManager.getInstance().getString("image.dialog.ok"));
        panel1.add(OKButton);
        OKButton.setFont(new Font("Dialog", Font.PLAIN, 12));
        OKButton.setBounds(new Rectangle(56, 302, 79, 22));
        CancelButton.setText(LanguageManager.getInstance().getString("image.dialog.cancel"));
        panel1.add(CancelButton);
        CancelButton.setFont(new Font("Dialog", Font.PLAIN, 12));
        CancelButton.setBounds(new Rectangle(164, 302, 79, 22));
        label1.setText(LanguageManager.getInstance().getString("image.dialog.height"));
        ...
        label2.setText(LanguageManager.getInstance().getString("image.dialog.x"));
        label2.setHorizontalAlignment(JLabel.RIGHT);
        panel1.add(label2);
        label2.setBounds(new Rectangle(24, 36, 48, 24));
        panel1.add(yField);
        yField.setBounds(new Rectangle(84, 60, 36, 24));
        label3.setText(LanguageManager.getInstance().getString("image.dialog.y"));
        label3.setHorizontalAlignment(JLabel.RIGHT);
        panel1.add(label3);
        label3.setBounds(new Rectangle(24, 60, 48, 24));
        visibleBox.setText(LanguageManager.getInstance().getString("image.dialog.visible"));
        panel1.add(visibleBox);
        visibleBox.setBounds(new Rectangle(24, 96, 96, 24));
        selectableBox.setText(LanguageManager.getInstance().getString("image.dialog.selectable"));
        panel1.add(selectableBox);
        selectableBox.setBounds(new Rectangle(24, 120, 96, 24));
        resizableBox.setText(LanguageManager.getInstance().getString("image.dialog.resizable"));
        panel1.add(resizableBox);
        resizableBox.setBounds(new Rectangle(24, 144, 96, 24));
        draggableBox.setText(LanguageManager.getInstance().getString("image.dialog.draggable"));
        panel1.add(draggableBox);
        draggableBox.setBounds(new Rectangle(24, 168, 96, 24));
        label4.setText(LanguageManager.getInstance().getString("image.dialog.width"));
        label4.setHorizontalAlignment(JLabel.RIGHT);
        panel1.add(label4);
        label4.setBounds(new Rectangle(132, 36, 48, 24));
        panel1.add(widthField);
        widthField.setBounds(new Rectangle(192, 36, 36, 24));
        classNameLabel.setText(LanguageManager.getInstance().getString("image.dialog.class.name"));
        panel1.add(classNameLabel);
        classNameLabel.setBounds(new Rectangle(23, 5, 264, 24));
        fromLabel.setText(LanguageManager.getInstance().getString("image.dialog.image.location"));
        panel1.add(fromLabel);
        fromLabel.setBounds(new Rectangle(156, 120, 100, 24));
        group1.add(fromFile);
        group1.add(fromURL);
        fromFile.setText(LanguageManager.getInstance().getString("image.dialog.from.file"));
        panel1.add(fromFile);
        fromFile.setBounds(new Rectangle(156, 144, 100, 24));
        fromURL.setText(LanguageManager.getInstance().getString("image.dialog.from.url"));
        panel1.add(fromURL);
        fromURL.setBounds(new Rectangle(156, 168, 100, 24));
        label5.setText(LanguageManager.getInstance().getString("image.dialog.url.pathname"));
        panel1.add(label5);
        label5.setBounds(new Rectangle(24, 192, 150, 24));
        panel1.add(location);
        location.setBounds(new Rectangle(24, 216, 246, 24));
        transparent.setText(LanguageManager.getInstance().getString("image.dialog.transparent.background"));
        panel1.add(transparent);
        transparent.setBounds(new Rectangle(50, 246, 200, 24));
        transButton.setText(LanguageManager.getInstance().getString("image.dialog.transparent.fill.color"));
