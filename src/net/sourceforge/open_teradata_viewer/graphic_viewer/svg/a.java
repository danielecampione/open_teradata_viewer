 ...
 *
 */
public class a extends AbstractNode implements IDomCDATASection {

    public a(CDATASection cdatasection) {
        super(cdatasection);
    }

    public CDATASection _mthif() {
        return (CDATASection) getNode();
    }

    public String getTextString() {
        CDATASection cdatasection = _mthif();
