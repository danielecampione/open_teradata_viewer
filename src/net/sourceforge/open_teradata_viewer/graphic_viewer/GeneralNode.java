...
public class GeneralNode extends GraphicViewerNode {
    ...
    public void initialize(Point point, Dimension dimension,
        ...
        for (int k = 0; k < i; k++) {
            ...
            GeneralNodePort generalnodeport = new GeneralNodePort(true, s2,
                    this);
            new GeneralNodePortLabel(s2, generalnodeport);
        ...
        for (int l = 0; l < j; l++) {
            ...
            GeneralNodePort generalnodeport1 = new GeneralNodePort(false, s3,
                    this);
            new GeneralNodePortLabel(s3, generalnodeport1);
        ...
        if (domdoc.GraphicViewerXMLOutputEnabled()) {
            IDomElement domelement1 = domdoc
                    .createGraphicViewerClassElement(
                            "net.sourceforge.open_teradata_viewer.graphic_viewer.GeneralNode",
                            domelement);
            if (myTopLabel != null)
    ...
    protected ArrayList<Object> myLeftPorts;

    protected ArrayList<Object> myRightPorts;
}