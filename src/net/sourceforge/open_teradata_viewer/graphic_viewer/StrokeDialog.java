...
public class StrokeDialog extends JDialog {
    ...
    void jbInit() throws Exception {
        ...
        OKButton.setText(LanguageManager.getInstance().getString("stroke.dialog.ok"));
        OKButton.setFont(new Font("Dialog", Font.PLAIN, 12));
        OKButton.setBounds(new Rectangle(166, 293, 79, 22));
        CancelButton.setText(LanguageManager.getInstance().getString("stroke.dialog.cancel"));
        CancelButton.setFont(new Font("Dialog", Font.PLAIN, 12));
        CancelButton.setBounds(new Rectangle(274, 293, 79, 22));
        label1.setText(LanguageManager.getInstance().getString("stroke.dialog.height"));
        label1.setHorizontalAlignment(JLabel.RIGHT);
        isResizingRelinks.setBackground(Color.lightGray);
        isResizingRelinks.setText(LanguageManager.getInstance().getString("stroke.dialog.resizing.relinks"));
        isResizingRelinks.setBounds(new Rectangle(6, 102, 110, 23));
        jLabel2.setText(LanguageManager.getInstance().getString("stroke.dialog.adjusting.style"));
        jLabel2.setBounds(new Rectangle(4, 126, 85, 15));
        End.setBackground(Color.lightGray);
        End.setText(LanguageManager.getInstance().getString("stroke.dialog.end"));
        End.setBounds(new Rectangle(21, 154, 91, 17));
        Scale.setBackground(Color.lightGray);
        Scale.setText(LanguageManager.getInstance().getString("stroke.dialog.scale"));
        Scale.setBounds(new Rectangle(21, 167, 91, 17));
        Stretch.setBackground(Color.lightGray);
        Stretch.setText(LanguageManager.getInstance().getString("stroke.dialog.stretch"));
        Stretch.setBounds(new Rectangle(21, 181, 91, 18));
        Calculate.setBackground(Color.lightGray);
        Calculate.setText(LanguageManager.getInstance().getString("stroke.dialog.calculate"));
        ...
        label2.setText(LanguageManager.getInstance().getString("stroke.dialog.x"));
        label2.setHorizontalAlignment(JLabel.RIGHT);
        panel1.add(label2);
        label2.setBounds(new Rectangle(372, 18, 48, 24));
        panel1.add(yField);
        yField.setBounds(new Rectangle(434, 42, 36, 24));
        label3.setText(LanguageManager.getInstance().getString("stroke.dialog.y"));
        label3.setHorizontalAlignment(JLabel.RIGHT);
        panel1.add(label3);
        label3.setBounds(new Rectangle(372, 42, 48, 24));
        visibleBox.setText(LanguageManager.getInstance().getString("stroke.dialog.visible"));
        panel1.add(visibleBox);
        visibleBox.setBounds(new Rectangle(236, 24, 72, 24));
        selectableBox.setText(LanguageManager.getInstance().getString("stroke.dialog.selectable"));
        panel1.add(selectableBox);
        selectableBox.setBounds(new Rectangle(236, 44, 84, 24));
        resizableBox.setText(LanguageManager.getInstance().getString("stroke.dialog.resizable"));
        panel1.add(resizableBox);
        resizableBox.setBounds(new Rectangle(324, 24, 84, 24));
        draggableBox.setText(LanguageManager.getInstance().getString("stroke.dialog.draggable"));
        panel1.add(draggableBox);
        draggableBox.setBounds(new Rectangle(324, 44, 84, 24));
        label4.setText(LanguageManager.getInstance().getString("stroke.dialog.width"));
        label4.setHorizontalAlignment(JLabel.RIGHT);
        panel1.add(label4);
        label4.setBounds(new Rectangle(472, 18, 48, 24));
        panel1.add(widthField);
        widthField.setBounds(new Rectangle(532, 18, 36, 24));
        brushColorButton.setText(LanguageManager.getInstance().getString("stroke.dialog.fill.color"));
        ...
        solidBrushBox.setText(LanguageManager.getInstance().getString("stroke.dialog.solid.brush"));
        ...
        JPanel3.add(label9);
        startArrow.setText(LanguageManager.getInstance().getString("stroke.dialog.start.arrow"));
        JPanel3.add(startArrow);
        startArrow.setBounds(new Rectangle(10, 28, 84, 24));
        startArrow.setBackground(java.awt.Color.lightGray);
        endArrow.setText(LanguageManager.getInstance().getString("stroke.dialog.end.arrow"));
        JPanel3.add(endArrow);
        endArrow.setBounds(new Rectangle(10, 49, 84, 24));
        endArrow.setBackground(java.awt.Color.lightGray);
        highlightColorButton.setText(LanguageManager.getInstance().getString("stroke.dialog.highlight.color"));
        ...
        jLabel1.setText(LanguageManager.getInstance().getString("stroke.dialog.link.properties"));
        jLabel1.setBounds(new Rectangle(18, 5, 83, 17));
        isJumpsOver.setBackground(Color.lightGray);
        isJumpsOver.setText(LanguageManager.getInstance().getString("stroke.dialog.jumps.over"));
        isJumpsOver.setBounds(new Rectangle(6, 25, 91, 25));
        isAvoidsNodes.setBackground(Color.lightGray);
        isAvoidsNodes.setText(LanguageManager.getInstance().getString("stroke.dialog.avoids.nodes"));
        isAvoidsNodes.setBounds(new Rectangle(6, 45, 101, 25));
        isRelinkable.setBackground(Color.lightGray);
        isRelinkable.setText(LanguageManager.getInstance().getString("stroke.dialog.relinkable"));
        isRelinkable.setBounds(new Rectangle(6, 66, 84, 21));
        isOrtho.setBackground(Color.lightGray);
        isOrtho.setText(LanguageManager.getInstance().getString("stroke.dialog.orthogonal"));
        isOrtho.setBounds(new Rectangle(6, 82, 84, 24));
        label15.setText(LanguageManager.getInstance().getString("stroke.dialog.curviness"));
        ...
        isCubic.setText(LanguageManager.getInstance().getString("stroke.dialog.cubic.bezier"));
        panel1.add(isCubic);
        isCubic.setBounds(new Rectangle(430, 64, 124, 24));
        penColorButton.setText(LanguageManager.getInstance().getString("stroke.dialog.pen.color"));
        ...
        solidPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.solid.line.pen"));
        ...
        dashedPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.dashed.line.pen"));
        ...
        dottedPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.dotted.line.pen"));
        ...
        dashdotPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.dash.dot.pen"));
        ...
        dashdotdotPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.dash.dot.dot.pen"));
        ...
        customPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.custom.pen"));
        ...
        noPenButton.setText(LanguageManager.getInstance().getString("stroke.dialog.no.pen"));
        ...
        label5.setText(LanguageManager.getInstance().getString("stroke.dialog.pen.properties"));
        label5.setFont(new Font("Dialog", Font.ITALIC, 12));
        label5.setBounds(new Rectangle(26, 2, 95, 23));
        label6.setText(LanguageManager.getInstance().getString("stroke.dialog.pen.width"));
        ...
        label8.setText(LanguageManager.getInstance().getString("stroke.dialog.brush.properties"));
        label8.setFont(new Font("Dialog", Font.ITALIC, 12));
        JPanel3.setLayout(null);
        panel1.add(JPanel3);
        label9.setText(LanguageManager.getInstance().getString("stroke.dialog.arrow.properties"));
        label9.setFont(new Font("Dialog", Font.ITALIC, 12));
        label9.setBounds(new Rectangle(22, 1, 95, 25));
        JPanel3.add(label10);
        label10.setText(LanguageManager.getInstance().getString("stroke.dialog.arrow.length"));
        label10.setBounds(new Rectangle(10, 72, 95, 23));
        JPanel3.add(arrowLength);
        arrowLength.setBounds(new Rectangle(10, 91, 48, 24));
        JPanel3.add(label11);
        label11.setText(LanguageManager.getInstance().getString("stroke.dialog.shaft.length"));
        label11.setBounds(new Rectangle(10, 119, 95, 23));
        JPanel3.add(shaftLength);
        shaftLength.setBounds(new Rectangle(10, 138, 48, 24));
        JPanel3.add(label12);
        label12.setText(LanguageManager.getInstance().getString("stroke.dialog.arrow.width"));
        label12.setBounds(new Rectangle(10, 166, 128, 23));
        JPanel3.add(arrowWidth);
        arrowWidth.setBounds(new Rectangle(10, 185, 115, 24));
        JPanel4.add(label13);
        label13.setText(LanguageManager.getInstance().getString("stroke.dialog.highlight.properties"));
        label13.setFont(new Font("Dialog", Font.ITALIC, 12));
        label13.setBounds(new Rectangle(12, 2, 130, 23));
        panel1.add(label14);
        label14.setText(LanguageManager.getInstance().getString("stroke.dialog.highlight.width"));
        ...
        solidHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.solid.highlight"));
        dashedHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.dashed.line"));
        dottedHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.dotted.line"));
        dashdotHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.dash.dot.line"));
        dashdotdotHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.dash.dot.dot.line"));
        customHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.custom.highlight"));
        noHighlight.setText(LanguageManager.getInstance().getString("stroke.dialog.no.highlight"));
