...
public class Network {
    ...
    public Network() {
        _fldnew = new LinkedList<Object>();
        _fldif = null;
        _fldint = new LinkedList<Object>();
        a = null;
        _fldfor = new HashMap<GraphicViewerObject, NetworkNode>();
        _flddo = new HashMap<GraphicViewerObject, NetworkLink>();
    }
    ...
    public void deleteSelfLinks() {
        ArrayList<NetworkLink> arraylist = new ArrayList<NetworkLink>();
    ...
    public GraphicViewerSelection getNodesAndLinks(
        ...
        Iterator<Object> iterator = getNodeIterator();
        do {
            if (!iterator.hasNext())
                break;
    ...
    public Iterator<Object> getNodeIterator() {
        return _fldnew.iterator();
    }

    public Iterator<Object> getNodeIterator(int i) {
        if (_fldnew.size() < i)
            return _fldnew.iterator();
        else
    ...
    public Iterator<Object> getLinkIterator() {
        return _fldint.iterator();
    }

    public Iterator<Object> getLinkIterator(int i) {
        if (i > _fldint.size())
            return _fldint.iterator();
        else
    ...
    protected LinkedList<Object> getNetworkLinks() {
        return _fldint;
    }

    protected LinkedList<Object> getNetworkNodes() {
        return _fldnew;
    }

    protected HashMap<GraphicViewerObject, NetworkNode> getGoObjToNodeMap() {
        return _fldfor;
    }

    protected HashMap<GraphicViewerObject, NetworkLink> getGoObjToLinkMap() {
        return _flddo;
    }

    private LinkedList<Object> _fldnew;
    private NetworkNode _fldif[];
    private LinkedList<Object> _fldint;
    private NetworkLink a[];
    private HashMap<GraphicViewerObject, NetworkNode> _fldfor;
    private HashMap<GraphicViewerObject, NetworkLink> _flddo;
}