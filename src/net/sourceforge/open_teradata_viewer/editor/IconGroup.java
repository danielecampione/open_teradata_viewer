 ...
 * for an instance of <code>TextArea</code>. If the location of the icon group
...
public class IconGroup {
     ...
     * @param extension The extension of the icons (one of <code>gif</code>,
     *                  <code>jpg</code>, or <code>png</code>).
     * @param jar The Jar file containing the icons, or <code>null</code> if the
     *            icons are on the local file system. If a Jar is specified, the
     *            value of <code>path</code> must be a path in the Jar file. If
     *            this is not a valid Jar file, then no Jar file will be used,
    ...
    public Icon getIcon(String name) {
        ...
        // cases (new ImageIcon(url) where url is not resolved?). We'll just
        // return null in this case as Swing AbstractButtons throw exceptions
        // when expected to paint an icon with width or height is less than 1
        if (icon != null
     ...
     *                     system or in the Jar file, if this icon group
     *                     represents icons in a Jar file.
     * @return The icon.
     */
    ...
    /**
     * Returns the large icon from this icon group with the specified name. If
     * this icon group does not have large icons, <code>null</code> is returned.
     *
     * @param name The name of the icon. For example, if you want the icon
     *             specified in <code>new.gif</code>, this value should be
     *             <code>new</code>.
    ...
    public Icon getLargeIcon(String name) {
        return getIconImpl(path + largeIconSubDir + "/" + name + "."
                + extension);
    }
