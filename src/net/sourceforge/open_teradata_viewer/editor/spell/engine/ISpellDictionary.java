...
public interface ISpellDictionary {
     ...
     * different the suggested word is from the sourceWord.
     * If the words are the exactly the same, then the score is 0.
     * You can get the dictionary to only return the most similar words by
     * setting an appropriately low threshold value.
     * If you set the threshold value too low, you may get no suggestions for a
     * given word.<p/>
     *
     ...
     * @see net.sourceforge.open_teradata_viewer.editor.spell.engine.Word
     */
