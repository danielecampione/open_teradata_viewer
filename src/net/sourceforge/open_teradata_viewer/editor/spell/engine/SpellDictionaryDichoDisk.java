...
/**
 * Another implementation of <code>ISpellDictionary</code> that doesn't cache
 * any words in memory. Avoids the huge footprint of
...
public class SpellDictionaryDichoDisk extends SpellDictionaryASpell {
     ...
     *        wordlist.
     * @throws java.io.FileNotFoundException indicates problems locating the file
     *         on the system.
     * @throws java.io.IOException Indicates problems reading the words list
     *         file.
     */
