 ...
 * phonetic version of it. This allows for phonetic matches in a spell
 * checker.<p/>
 * 
 * @author D. Campione
 * 
 */
public class DoubleMeta implements ITransformator {
     ...
     * Vowels are minimized as much as possible and consonants that have
     * similar sounds are converted to the same consonant for example, 'v' and
     * 'f' are both converted to 'f'.
     * 
    ...
    /**
     * @see net.sourceforge.open_teradata_viewer.editor.spell.engine.ITransformator#getReplaceList()
     */
    @Override
