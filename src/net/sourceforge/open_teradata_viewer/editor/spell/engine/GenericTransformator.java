...
/**
 * <p>A generic implementation of a transformator takes an <a
 ...
 *
 * @author D. Campione
 * @see SpellDictionaryASpell for information on getting phonetic files for
 *      aspell.
 * 
 */
public class GenericTransformator implements ITransformator {
     ...
     * this language. The keyword must be followed an {@link
     * GenericTransformator#ALPHABET_START ALPHABET_START} marker, a list of
     * characters defining the alphabet and a {@link
     * GenericTransformator#ALPHABET_END ALPHABET_END} marker.
     */
     ...
     * In other words, it removes any letters in the alphabet that are redundant
     * phonetically.
     *
    ...
    /**
     * Builds up a char array with the chars in the alphabet of the language as
    ...
    public String transform(String word) {
        ...
        while (startPos < strLength) {
            ...
            if (Character.isDigit(str.charAt(startPos))) {
                StringUtil.replace(str, startPos,
    ...
    private void buildRule(String str, Vector ruleList) {
        ...
        // A different alphabet is used for this language, will be read into the
        // alphabetString variable
