 ...
 * net.sourceforge.open_teradata_viewer.editor.syntax.SyntaxTextArea} that adds
 ...
 * 
 */
public class TextEditorPane extends SyntaxTextArea implements DocumentListener {

    private static final long serialVersionUID = 7464489769100116795L;
    ...
    /**
     * Ctor. The file will be given a default name.
     */
    ...
    /**
     * Creates a new <code>TextEditorPane</code>. The file will be given a
     * default name.
     *
     * @param textMode Either <code>INSERT_MODE</code> or
     *                 <code>OVERWRITE_MODE</code>.
    ...
    public TextEditorPane(int textMode, boolean wordWrapEnabled) {
        ...
        try {
            ...
            ExceptionDialog.notifyException(ioe); // Never happens
        }
    }
     ...
     *                 <code>OVERWRITE_MODE</code>.
     * @param wordWrapEnabled Whether or not to use word wrap in this pane.
     * @param loc The location of the text file being edited. If this value is
     *            <code>null</code>, a file named "Untitled.txt" in the current
     *            directory is used.
     * @throws IOException If an IO error occurs reading the file at
     *         <code>loc</code>. This of course won't happen if <code>loc</code>
     *         is <code>null</code>.
     */
    public TextEditorPane(int textMode, boolean wordWrapEnabled,
     ...
     *            actually exists.
     * @param defaultEnc The default encoding to use when opening the file, if
     *                   the file is not Unicode. If this value is
    ...
    /**
     * Callback for when styles in the current document change. This method is
     * never called.
     *
    ...
    /**
     * Returns the timestamp for when this file was last loaded or saved <em>by
     * this editor pane</em>. If the file has been modified on disk by another
     * process after it was loaded into this editor pane, this method will not
     * return the actual file's last modified time.<p>
     *
     * For remote files, this method will always return {@link
     * #LAST_MODIFIED_UNKNOWN}.
     *
     * @return The timestamp when this file was last loaded or saved by this
     *         editor pane, if it is a local file, or {@link
     *         #LAST_MODIFIED_UNKNOWN} if it is a remote file.
     ...
     * defines its property values. If you always use {@link
     * #setLineSeparator(String)} to modify this value, then the value returned
     * from this method will always be a <code>String</code>.
     *
    ...
    public Object getLineSeparator() {
        return getDocument().getProperty(
                TextAreaEditorKit.EndOfLineStringProperty);
    }
    ...
    private void init(FileLocation loc, String defaultEnc) throws IOException {
        if (loc == null) {
            // Don't call load() just in case Untitled.txt actually exists, just
            // to ensure there is no chance of an IOException being thrown in
            // the default case
            ...
            // does not exist (or is the "default" file). This makes life easier
            // for host applications that want to display this value
    ...
    /** @return Whether this file is a local file. */
     ...
     *                   encoding will only be used if the file is not Unicode.
     *                   If this value is <code>null</code>, the system default
     *                   encoding is used.
    ...
    /**
     * Reloads this file from disk. The file must exist for this operation to
     * not throw an exception.<p>
     * 
     * The file's "dirty" state will be set to <code>false</code> after this
     * operation. If this is a local file, its "last modified" time is updated
     * to reflect that of the actual file.<p>
     *
     ...
     *
     * The text area's "dirty" state is set to <code>false</code>, and if this
     * is a local file, its "last modified" time is updated.
     *
     * @throws IOException If an IO error occurs.
     * @see #saveAs(FileLocation)
    ...
    /**
     * Sets the encoding to use when reading or writing this file. This method
     * sets the editor's dirty flag when the encoding is changed.
     *
    ...
    public void setLineSeparator(String separator, boolean setDirty) {
        ...
        Document doc = getDocument();
        Object old = doc.getProperty(TextAreaEditorKit.EndOfLineStringProperty);
        if (!separator.equals(old)) {
            doc.putProperty(TextAreaEditorKit.EndOfLineStringProperty,
                    separator);
            if (setDirty) {
                setDirty(true);
            }
    ...
    /**
     * Sets whether or not this text area should be treated as read-only. This
     * fires a property change event of type {@link #READ_ONLY_PROPERTY}.
     *
     ...
     * being edited, if that file is local and exists. If the file is remote or
     * is local but does not yet exist, nothing happens.<p>
     *
