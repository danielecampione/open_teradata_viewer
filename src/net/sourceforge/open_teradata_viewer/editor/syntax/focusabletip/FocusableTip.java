...
public class FocusableTip {
    ...
    private void computeTipVisibleBounds() {
        // Compute area that the mouse can move in without hiding the tip
        // window
    ...
    private void createAndShowTipWindow(final MouseEvent e, final String text) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                // Get x-coordinate of completions. Try to align left edge with
                // the mouse first (with a slight margin)
