...
class TipWindow extends JWindow implements ActionListener {
    ...
    private static final long serialVersionUID = -4417906975338492168L;
     ...
     * rendering HTML until after layout already done.
     */
    void fixSize() {
    ...
    private void setBottomPanel() {
        ...
        if (focusable) {
            ...
            JLabel label = new JLabel("Press 'F2' for focus");
     ...
     *
     * @param listener The new listener. The old listener (if any) is removed.
     *                 A value of <code>null</code> means "no listener."
     */
