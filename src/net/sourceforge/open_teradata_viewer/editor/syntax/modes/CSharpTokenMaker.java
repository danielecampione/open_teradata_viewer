...
/**
 * An object that can take a chunk of text and return a linked list of tokens
 * representing it in the C# programming language.
 *
...
public class CSharpTokenMaker extends AbstractJFlexCTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\2\1\1\1\0\2\15\22\0\1\2\1\45\1\41\1\16"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\2\0\2\1\1\2\1\3\1\4\2\5\2\6\1\7"
            ...
            + "\10\6\7\0\2\2\3\6\2\10\1\26\1\11\5\6" + "\2\0\1\2\3\6\1\0\1\6";
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\77\0\176\0\275\0\374\0\u013b\0\u017a\0\u01b9"
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\5\1\6\1\7\1\10\1\11\1\5\1\12\2\13"
     ...
     */
    public CSharpTokenMaker(Reader in) {
        this.zzReader = in;
    }
     ...
     */
    public CSharpTokenMaker(InputStream in) {
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 13: {
                int temp = zzStartRead;
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addToken(temp, zzEndRead, IToken.PREPROCESSOR);
                addNullToken();
                return firstToken;
            }
            case 50:
