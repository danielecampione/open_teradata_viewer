...
public class PerlTokenMaker extends AbstractJFlexCTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\12\1\11\1\0\1\12\1\6\22\0\1\12\1\46\1\102"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\11\0\1\1\1\2\2\3\1\1\1\4\1\5\1\6"
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\12\1\13\1\14\1\15\1\13\1\14\1\16\1\17"
            ...
            + "\1\12\5\13\1\0\2\12\2\0\4\13\4\0\1\12"
            + "\2\0\1\12\5\0\5\13\13\0\14\13\1\u01a2\11\13" + "\1\0\3\13";
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\11\0\4\1\1\11\1\1\1\11\3\1\2\11\4\1"
    ...
    /**
     * Token type specific to PerlTokenMaker; this signals that we are inside an
     * unquoted/double quoted/backtick EOF heredoc.
     */
    ...
    /**
     * Token type specific to PerlTokenMaker; this signals that we are inside an
     * unquoted/double quoted/backtick EOT heredoc.
     */
    public static final int INTERNAL_HEREDOC_EOT_UNQUOTED = -3;

    /**
     * Token type specific to PerlTokenMaker; this signals that we are inside an
     * single quoted EOT heredoc.
     */
    ...
    public boolean getMarkOccurrencesOfTokenType(int type) {
        return super.getMarkOccurrencesOfTokenType(type)
                || type == IToken.VARIABLE;
    }
     ...
     */
    public PerlTokenMaker(Reader in) {
        this.zzReader = in;
    }
     ...
     */
    public PerlTokenMaker(InputStream in) {
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 34: {
                ...
                addToken(start, zzStartRead - 1, IToken.LITERAL_BACKQUOTE);
            ...
            case 40: {
                if (start == zzStartRead) {
                    addToken(IToken.COMMENT_DOCUMENTATION);
                    yybegin(YYINITIAL);
                }
            }
            case 48:
            ...
            case 55:
                break;
            case 24: {
                addToken(start, zzStartRead - 1, IToken.PREPROCESSOR);
            ...
            case 41: {
                if (start == zzStartRead) {
                    ...
                    addToken(temp, zzMarkedPos - 1, IToken.COMMENT_EOL);
                    start = zzMarkedPos;
                }
            }
            case 59:
            ...
            case 20: {
                yybegin(YYINITIAL);
                addToken(start, zzStartRead, IToken.LITERAL_BACKQUOTE);
            }
            case 72:
                break;
            case 15: {
