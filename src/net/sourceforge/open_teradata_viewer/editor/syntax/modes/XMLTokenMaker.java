...
import net.sourceforge.open_teradata_viewer.editor.syntax.XmlOccurrenceMarker;
...
public class XMLTokenMaker extends AbstractMarkupTokenMaker {
    ...
    /**
     * Whether the DTD we're currently in is a locally-defined one. This field
     * is only valid when in a DOCTYPE element (the <DTD> state).
     */
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 9: {
                addToken(start, zzStartRead - 1, IToken.MARKUP_DTD);
                addEndToken(inInternalDtd ? INTERNAL_DTD_INTERNAL
                        : INTERNAL_DTD);
                return firstToken;
            }
            case 38:
            ...
            case 7: {
                ...
                addEndToken(INTERNAL_IN_XML_COMMENT - prevState);
                return firstToken;
            }
            case 40:
                break;
