...
public class JSPTokenMaker extends AbstractMarkupTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\4\1\2\1\0\1\1\1\45\22\0\1\4\1\26\1\10"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\6\0\2\1\1\0\2\1\1\0\2\1\14\0\1\2"
            ...
            + "\1\2\2\0\3\2\2\0\1\2\2\0\1\2\4\0" + "\1\2\2\0\1\165\13\0";
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\133\0\266\0\u0111\0\u016c\0\u01c7\0\u0222\0\u027d"
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\37\1\40\1\41\1\42\1\43\1\44\125\37\2\45"
    ...
    private static final String ZZ_TRANS_PACKED_1 = "\2\150\1\137\12\0\6\150\1\0\3\150\2\0\6\150"
            + "\1\0\1\u0156\6\150\1\0\1\137\1\150\1\0\3\150"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\6\0\2\1\1\0\2\1\1\0\2\1\14\0\1\1"
            ...
            + "\2\0\1\1\2\0\3\1\2\0\1\1\2\0\1\1" + "\4\0\1\1\2\0\1\1\13\0";
    ...
    /**
     * Token type specifying that the user has ended a line with an unclosed
     * <code>&lt;style&gt;</code> tag.
     */
    ...
    /**
     * Token type specifying we're in a JSP directive (either include, page or
     * taglib).
     */
    ...
    /**
     * Token type specifying we're in an invalid multi-line JS single-quoted
     * string.
     */
    private static final int INTERNAL_IN_JS_CHAR_INVALID = -16;

    /**
     * Token type specifying we're in a valid multi-line JS single-quoted
     * string.
     */
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 10: {
                yybegin(YYINITIAL);
                addToken(start, zzStartRead, IToken.MARKUP_DTD);
            }
            case 134:
                break;
            case 61: {
            ...
            case 136:
                break;
            case 4: {
                addToken(IToken.MARKUP_TAG_DELIMITER);
                yybegin(INTAG);
            }
            case 137:
                break;
            case 124: {
                addToken(IToken.RESERVED_WORD_2);
            }
            case 138:
                break;
            case 104: {
            ...
            case 140:
                break;
            case 41: { /* Line ending in '\' => continue to next line */
                if (validJSString) {
                    addToken(start, zzStartRead, IToken.LITERAL_CHAR);
                    addEndToken(INTERNAL_IN_JS_CHAR_VALID);
                } else {
                    addToken(start, zzStartRead, IToken.ERROR_CHAR);
            ...
            case 142:
                break;
            case 125: {
                addToken(zzStartRead, zzStartRead, IToken.MARKUP_TAG_DELIMITER);
                addToken(zzMarkedPos - 6, zzMarkedPos - 1,
                        IToken.MARKUP_TAG_NAME);
                start = zzMarkedPos;
            ...
            case 129: {
                ...
                addToken(temp, temp + 1, IToken.MARKUP_TAG_DELIMITER);
                addToken(zzMarkedPos - 7, zzMarkedPos - 2,
                        IToken.MARKUP_TAG_NAME);
                addToken(zzMarkedPos - 1, zzMarkedPos - 1,
            ...
            case 93: {
                int temp = zzStartRead;
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addToken(temp, zzMarkedPos - 1, IToken.COMMENT_MARKUP);
                start = zzMarkedPos;
            }
            case 148:
                break;
            case 8: {
                addToken(start, zzStartRead - 1,
                        IToken.MARKUP_PROCESSING_INSTRUCTION);
                return firstToken;
            }
            case 149:
                break;
            case 36: {
                addToken(start, zzStartRead - 1, IToken.ERROR_STRING_DOUBLE);
            ...
            case 152:
                break;
            case 20: { /* Allowing JSP expressions, etc.. */
            }
            case 153:
                break;
            case 26: {
                start = zzMarkedPos - 1;
                yybegin(INATTR_DOUBLE_STYLE);
            }
            case 154:
                break;
            case 119: {
                yybegin(YYINITIAL);
                addToken(start, zzStartRead + 3, IToken.MARKUP_COMMENT);
            }
            case 155:
                break;
            case 89: { /* Skip all escaped chars */
            }
            case 156:
                break;
            case 83: {
            ...
            case 29: {
                yybegin(INTAG_STYLE);
                addToken(start, zzStartRead, IToken.MARKUP_TAG_ATTRIBUTE_VALUE);
            }
            case 158:
                break;
            case 116: {
            ...
            case 27: {
                start = zzMarkedPos - 1;
                yybegin(INATTR_SINGLE_STYLE);
            }
            case 165:
                break;
            case 54: {
                addToken(IToken.IDENTIFIER); /* Needed as InTagIdentifier ignores it */
            }
            case 166:
                break;
            case 7: {
                addToken(start, zzStartRead - 1, IToken.MARKUP_COMMENT);
                return firstToken;
            }
            case 167:
                break;
            case 91: { /* Invalid latin-1 character \xXX */
                validJSString = false;
            }
            case 168:
                break;
            ...
            case 169:
                break;
            case 37: {
                int type = validJSString ? IToken.LITERAL_STRING_DOUBLE_QUOTE
                        : IToken.ERROR_STRING_DOUBLE;
            ...
            case 170:
                break;
            case 114: {
                addToken(IToken.COMMENT_MULTILINE);
            }
            case 171:
                break;
            case 47: {
                addToken(IToken.ERROR_STRING_DOUBLE);
                addEndToken(INTERNAL_IN_JAVA_EXPRESSION - jspInState);
                return firstToken;
            }
            case 172:
                break;
            ...
            case 126: {
                yybegin(YYINITIAL, LANG_INDEX_DEFAULT);
                addToken(zzStartRead, zzStartRead + 1,
                        IToken.MARKUP_TAG_DELIMITER);
                addToken(zzMarkedPos - 6, zzMarkedPos - 2,
                        IToken.MARKUP_TAG_NAME);
                addToken(zzMarkedPos - 1, zzMarkedPos - 1,
                        IToken.MARKUP_TAG_DELIMITER);
            }
            ...
            case 176:
                break;
            case 9: {
                addToken(start, zzStartRead - 1, IToken.MARKUP_DTD);
                return firstToken;
            }
            case 177:
                break;
            ...
            case 178:
                break;
            case 73: { /* Skip escaped chars */
            }
            case 179:
                break;
            case 90: { /* Invalid Unicode character \\uXXXX */
                validJSString = false;
            }
            case 180:
                break;
            case 123: {
                addToken(zzStartRead, zzStartRead, IToken.MARKUP_TAG_DELIMITER);
                addToken(zzMarkedPos - 5, zzMarkedPos - 1,
                        IToken.MARKUP_TAG_NAME);
                start = zzMarkedPos;
                cssPrevState = zzLexicalState;
                yybegin(INTAG_STYLE);
            ...
            case 186:
                break;
            case 39: {
                addToken(start, zzStartRead - 1, IToken.ERROR_CHAR);
                addEndToken(INTERNAL_IN_JS);
                return firstToken;
            }
            case 187:
            ...
            case 107: {
                yybegin(YYINITIAL);
                addToken(start, zzStartRead + 2, IToken.MARKUP_COMMENT);
            }
            case 193:
                break;
            case 102: {
            ...
            case 24: {
                addToken(IToken.MARKUP_TAG_DELIMITER);
                yybegin(JAVASCRIPT, LANG_INDEX_JS);
            }
            case 199:
                break;
            case 96: {
            ...
            case 45: {
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addEndToken(INTERNAL_IN_JAVA_DOCCOMMENT - jspInState);
                return firstToken;
            }
            case 205:
                break;
            ...
            case 208:
                break;
            case 40: {
                int type = validJSString ? IToken.LITERAL_CHAR
                        : IToken.ERROR_CHAR;
                addToken(start, zzStartRead, type);
                yybegin(JAVASCRIPT);
            }
            ...
            case 50: {
                addToken(start, zzStartRead - 1, IToken.COMMENT_MULTILINE);
                addEndToken(INTERNAL_IN_JAVA_MLC - jspInState);
                return firstToken;
            }
            case 217:
                break;
            ...
            case 113: {
                int temp = zzStartRead;
                addToken(start, zzStartRead - 1, IToken.MARKUP_COMMENT);
                addHyperlinkToken(temp, zzMarkedPos - 1, IToken.MARKUP_COMMENT);
                start = zzMarkedPos;
            }
            case 221:
                break;
            case 6: {
                addToken(IToken.MARKUP_ENTITY_REFERENCE);
            }
            case 222:
                break;
            case 115: {
            ...
            case 238:
                break;
            case 69: { /* End of a function */
                addToken(IToken.SEPARATOR);
            }
            case 239:
                break;
            case 19: {
                addToken(IToken.MARKUP_TAG_NAME);
            }
            case 240:
                break;
            case 11: {
                addToken(IToken.MARKUP_TAG_ATTRIBUTE);
            }
            case 241:
                break;
            case 121: {
                int temp = zzStartRead;
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addToken(temp, zzMarkedPos - 1, IToken.COMMENT_KEYWORD);
                start = zzMarkedPos;
            }
            case 242:
                break;
            ...
            case 243:
                break;
            case 38: { /* Line ending in '\' => continue to next line */
                if (validJSString) {
                    addToken(start, zzStartRead,
                            IToken.LITERAL_STRING_DOUBLE_QUOTE);
                    addEndToken(INTERNAL_IN_JS_STRING_VALID);
                } else {
                    addToken(start, zzStartRead, IToken.ERROR_STRING_DOUBLE);
            ...
            case 108: {
                ...
                if (firstToken == null) {
                    ...
                    // If this is *likely* to be a regex, based on the previous
                    // token, highlight it as such
                    IToken t = firstToken.getLastNonCommentNonWhitespaceToken();
                    if (SyntaxUtilities.regexCanFollowInJavaScript(t)) {
                        addToken(IToken.REGEX);
                        highlightedAsRegex = true;
                    }
                }
                ...
                if (!highlightedAsRegex) {
                    ...
                    addToken(zzStartRead, zzStartRead, IToken.OPERATOR);
            ...
            case 82: {
                int temp = zzStartRead;
                if (zzStartRead > start) {
                    addToken(start, zzStartRead - 1,
                            IToken.MARKUP_TAG_ATTRIBUTE_VALUE);
                }
                addToken(temp, zzMarkedPos - 1, IToken.MARKUP_TAG_DELIMITER);
                jspInState = zzLexicalState;
                yybegin(JAVA_EXPRESSION);
            }
            case 253:
            ...
            default:
                if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
                    ...
                    case JAVA_DOCCOMMENT: {
                        yybegin(JAVA_EXPRESSION);
                        addToken(start, zzEndRead, IToken.COMMENT_DOCUMENTATION);
                        addEndToken(INTERNAL_IN_JAVA_DOCCOMMENT - jspInState);
                        return firstToken;
                    }
                    case 1652:
                        break;
                    case INTAG_SCRIPT: {
                        addToken(zzMarkedPos, zzMarkedPos,
                    ...
                    case INATTR_SINGLE_STYLE: {
                        addToken(start, zzStartRead - 1,
                                IToken.MARKUP_TAG_ATTRIBUTE_VALUE);
                        addEndToken(INTERNAL_ATTR_SINGLE_QUOTE_STYLE);
                        return firstToken;
                    }
                    case 1665:
                        break;
                    ...
                    case INATTR_DOUBLE_STYLE: {
                        addToken(start, zzStartRead - 1,
                                IToken.MARKUP_TAG_ATTRIBUTE_VALUE);
                        addEndToken(INTERNAL_ATTR_DOUBLE_QUOTE_STYLE);
                        return firstToken;
                    }
                    case 1668:
                        break;
                    ...
                    case 1673:
                        break;
                    case INTAG_STYLE: {
                        addToken(zzMarkedPos, zzMarkedPos, INTERNAL_INTAG_STYLE);
                        return firstToken;
                    }
                    case 1674:
                        break;
