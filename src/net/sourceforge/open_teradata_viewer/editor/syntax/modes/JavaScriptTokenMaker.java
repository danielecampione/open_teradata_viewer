 ...
 *
 * Scanner for JavaScript files. Its states could be simplified, but are kept
 * the way they are to keep a degree of similarity (i.e. copy/paste) between it
 * and HTML/JSP/PHPTokenMaker. This should cause no difference in
 * performance.<p>
 *
 ...
 * <ul>
 *   <li>The generated <code>JavaScriptTokenMaker.java</code> file will contain
...
public class JavaScriptTokenMaker extends AbstractJFlexCTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\74\1\2\1\0\1\1\1\11\22\0\1\74\1\36\1\76"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\13\0\2\1\1\0\1\2\1\3\1\4\1\5\2\6"
            ...
            + "\1\102\4\0\1\102\12\0\3\5\6\0\1\5\2\0" + "\1\111\1\0";
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\113\0\226\0\341\0\u012c\0\u0177\0\u01c2\0\u020d"
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\17\1\20\1\21\1\22\1\23\1\24\1\22\1\23"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\13\0\2\1\1\0\2\1\1\11\4\1\1\11\4\1"
            ...
            + "\20\0\21\1\33\0\11\1\4\0\1\1\12\0\3\1" + "\6\0\1\1\2\0\1\11\1\0";
    ...
    public int getClosestStandardTokenTypeForInternalType(int type) {
        ...
        case INTERNAL_IN_JS_COMMENT_DOCUMENTATION:
            return ITokenTypes.COMMENT_DOCUMENTATION;
     ...
     * <code>SyntaxTextArea</code>s editing JavaScript if this property is
     * changed to see the difference.
     *
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 34: {
                start = zzMarkedPos - 1;
                yybegin(E4X_INATTR_SINGLE);
            }
            case 74:
                break;
            case 33: {
                start = zzMarkedPos - 1;
                yybegin(E4X_INATTR_DOUBLE);
            }
            case 75:
                break;
            case 36: {
            ...
            case 26: {
                ...
                addEndToken(e4x_inInternalDtd ? INTERNAL_E4X_DTD_INTERNAL
                        : INTERNAL_E4X_DTD);
                return firstToken;
            }
            case 78:
            ...
            case 41: {
                ...
                addToken(zzStartRead, zzStartRead + operatorLen - 1,
                        IToken.OPERATOR);
                if (yylen > operatorLen + 1) {
                    addToken(start + operatorLen, zzMarkedPos - 2,
                            IToken.WHITESPACE);
                }
            ...
            case 84:
                break;
            case 44: { /* Skip all escaped chars */
            }
            case 85:
                break;
            case 11: {
            ...
            case 60: {
                int temp = zzStartRead;
                yybegin(E4X);
                addToken(start, zzStartRead - 1, IToken.MARKUP_CDATA);
                addToken(temp, zzMarkedPos - 1, IToken.MARKUP_CDATA_DELIMITER);
            }
            case 88:
                break;
            case 58: {
                ...
                addToken(zzMarkedPos - (count - 2), zzMarkedPos - 1,
                        IToken.MARKUP_TAG_NAME);
                yybegin(E4X_INTAG);
            }
            case 89:
                break;
            case 46: { /* Invalid latin-1 character \xXX */
                validJSString = false;
            }
            case 90:
                break;
            ...
            case 96:
                break;
            case 45: { /* Invalid Unicode character \\uXXXX */
                validJSString = false;
            }
            case 97:
                break;
            ...
            case 18: {
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addEndToken(INTERNAL_IN_JS_COMMENT_DOCUMENTATION);
                return firstToken;
            }
            case 104:
                break;
            ...
            case 106:
                break;
            case 42: {
                addToken(isE4xSupported() ? IToken.MARKUP_TAG_ATTRIBUTE
                        : IToken.ERROR_IDENTIFIER);
            }
            case 107:
                break;
            case 68: {
            ...
            case 24: {
                ...
                addEndToken(INTERNAL_IN_E4X_COMMENT - e4x_prevState);
                return firstToken;
            }
            case 112:
                break;
            ...
            case 117:
                break;
            case 73: {
                addToken(IToken.MARKUP_CDATA_DELIMITER);
                start = zzMarkedPos;
                yybegin(E4X_CDATA);
            }
            case 118:
                break;
            case 31: {
                addToken(IToken.MARKUP_TAG_DELIMITER); /* Not valid but we'll still accept it */
            }
            case 119:
                break;
            case 2: {
            ...
            case 50: {
                ...
                addToken(zzMarkedPos - (count - 1), zzMarkedPos - 1,
                        IToken.MARKUP_TAG_NAME);
                yybegin(E4X_INTAG);
            }
            case 139:
            ...
            default:
                if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
                    ...
                    case 622:
                        break;
                    case E4X_INTAG: {
                        addToken(start, zzStartRead - 1, INTERNAL_E4X_INTAG);
                        return firstToken;
                    }
                    case 623:
                        break;
                    ...
                    case E4X_INATTR_SINGLE: {
                        ...
                        addEndToken(INTERNAL_E4X_ATTR_SINGLE);
                        return firstToken;
                    }
                    case 631:
                        break;
                    case E4X_INATTR_DOUBLE: {
                        addToken(start, zzStartRead - 1,
                                IToken.MARKUP_TAG_ATTRIBUTE_VALUE);
                        addEndToken(INTERNAL_E4X_ATTR_DOUBLE);
                        return firstToken;
                    }
                    case 632:
                        break;
                    ...
                    case E4X_CDATA: {
                        addToken(start, zzStartRead - 1, IToken.MARKUP_CDATA);
                        addEndToken(INTERNAL_E4X_MARKUP_CDATA);
                        return firstToken;
                    }
                    case 634:
                        break;
