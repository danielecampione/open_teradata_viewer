...
/**
 * Scanner for MXML. Generates tokens for MXML syntax highlighting.
 *
...
public class MxmlTokenMaker extends AbstractMarkupTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\12\1\10\1\0\1\7\1\36\22\0\1\105\1\16\1\32"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\5\0\2\1\1\0\2\1\4\0\2\2\1\3\1\4"
            ...
            + "\1\2\1\47\21\2\1\71\1\0\1\72\4\2\1\66" + "\40\2";
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\7\17\1\20\1\21\1\22\1\23\1\24\71\17\1\23"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\5\0\2\1\1\0\2\1\4\0\2\1\1\11\4\1"
            ...
            + "\23\1\3\0\3\1\1\11\21\1\1\11\1\0\1\11" + "\45\1";
    ...
    /**
     * Token type specific to this class; this signals that the user has ended a
     * line with an unclosed XML tag; thus a new line is beginning still inside
     * of the tag.
     */
    ...
    /**
     * Token type specific to this class; this signals that the user has ended a
     * line with an unclosed Script tag; thus a new line is beginning still
     * inside of the tag.
     */
    ...
    /**
     * Token type specific to this class; this signals that the user has ended a
     * line in the middle of a double-quoted attribute in a Script tag.
     */
    public static final int INTERNAL_ATTR_DOUBLE_QUOTE_SCRIPT = -5;

    /**
     * Token type specific to this class; this signals that the user has ended a
     * line in the middle of a single-quoted attribute in a Script tag.
     */
    public static final int INTERNAL_ATTR_SINGLE_QUOTE_SCRIPT = -6;

    /**
     * Token type specific to this class; this signals that the user has ended a
     * line in an ActionScript code block (text content inside a Script tag).
     */
    public static final int INTERNAL_IN_AS = -7;

    /**
     * Token type specific to this class; this signals that the user has ended a
     * line in an MLC in an ActionScript code block (text content inside a
     * Script tag).
     */
    ...
    public IToken getTokenList(Segment text, int initialTokenType,
        ...
        case INTERNAL_ATTR_SINGLE:
            ...
            start = text.offset;
            break;
        case IToken.MARKUP_PROCESSING_INSTRUCTION:
            state = PI;
            start = text.offset;
            break;
        case INTERNAL_INTAG:
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 28: {
                ...
                addEndToken(INTERNAL_IN_AS_MLC);
                return firstToken;
            }
            case 78:
                break;
            ...
            case 58: {
                ...
                addToken(zzStartRead, zzStartRead + 1,
                        IToken.MARKUP_TAG_DELIMITER);
                addToken(origStart + 2, origStart + 2 + tagNameLen - 1,
                        IToken.MARKUP_TAG_NAME);
                if (tagNameEnd < text.length() - 2) {
                    addToken(origStart + tagNameEnd + 1, zzMarkedPos - 2,
                            IToken.WHITESPACE);
                }
            ...
            default:
                if (zzInput == YYEOF && zzStartRead == zzCurrentPos) {
                    ...
                    case 626:
                        break;
                    case INTAG_SCRIPT: {
                        addToken(start, zzStartRead - 1, INTERNAL_INTAG_SCRIPT);
                        return firstToken;
                    }
                    case 627:
                        break;
