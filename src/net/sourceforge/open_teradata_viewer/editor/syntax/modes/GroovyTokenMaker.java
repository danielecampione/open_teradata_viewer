 ...
 * of tokens at a time, and hands the scanner this line as an array of
 * characters (a Segment really). Since tokens contain pointers to char arrays
 * instead of Strings holding their contents, there is no need for allocating
 * new memory for Strings.<p>
 *
...
public class GroovyTokenMaker extends AbstractJFlexCTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\22\1\21\1\0\1\22\1\16\22\0\1\22\1\53\1\13"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\4\0\2\1\1\0\1\2\1\3\2\4\1\3\1\5"
            ...
            + "\1\0\1\3\4\0\1\3\7\0\1\3\1\0\1\3" + "\30\0\1\35\37\0";
    ...
    private static final String ZZ_ROWMAP_PACKED_0 = "\0\0\0\126\0\254\0\u0102\0\u0158\0\u01ae\0\u0204\0\u025a"
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\10\2\11\1\12\1\13\1\12\1\14\1\12\1\15"
    ...
    private static final String ZZ_TRANS_PACKED_1 = "\1\0\1\10\1\11\4\0\6\11\2\0\6\11\14\0"
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\4\0\2\1\1\0\12\1\2\11\21\1\2\11\4\1"
            ...
            + "\4\0\1\1\7\0\1\1\1\0\1\1\30\0\1\1" + "\37\0";
     ...
     */
    private static final boolean regexCanFollow(IToken t) {
        char ch;
        return t == null
                ||
                //t.isOperator() ||
                ...
                ||
                /* Operators "==", "===", "!=", "!==", etc.. */
                (t.getType() == IToken.OPERATOR && ((ch = t
                        .charAt(t.length() - 1)) == '=' || ch == '~'));
    }
     ...
     */
    public GroovyTokenMaker(Reader in) {
        this.zzReader = in;
    }
     ...
     */
    public GroovyTokenMaker(InputStream in) {
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 41: {
                yybegin(YYINITIAL);
                addToken(start, zzStartRead + 2, IToken.LITERAL_CHAR);
            }
            case 63:
                break;
            case 46: {
                ...
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addToken(temp, zzMarkedPos - 1, IToken.VARIABLE);
                start = zzMarkedPos;
            }
            case 64:
                break;
            case 32: {
                int temp = zzStartRead;
                addToken(start, zzStartRead - 1, IToken.COMMENT_DOCUMENTATION);
                addToken(temp, zzMarkedPos - 1, IToken.PREPROCESSOR);
                start = zzMarkedPos;
            }
            case 65:
                break;
            ...
            case 68:
                break;
            case 19: { /* Skip escaped chars */
            }
            case 69:
                break;
            case 40: {
                yybegin(YYINITIAL);
                addToken(start, zzStartRead + 2,
