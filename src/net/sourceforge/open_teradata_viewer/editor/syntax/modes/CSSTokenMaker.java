...
public class CSSTokenMaker extends AbstractJFlexCTokenMaker {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\0\1\41\1\64\25\0\1\41\1\53\1\60\1\37\1\55\1\46"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\2\0\1\1\4\0\1\2\1\3\2\4\1\5\2\2"
            ...
            + "\31\0\6\43\21\0\3\43\14\0\2\43\7\0\1\43" + "\11\0\1\57\3\0";
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\1\10\1\11\2\12\1\13\2\12\1\14\25\12\1\15"
    ...
    public IToken yylex() throws IOException {
        ...
        while (true) {
            ...
            case 48:
                break;
            case 2: {
                /*System.out.println("yyinitial: " + yytext());*/ addToken(
                        IToken.IDENTIFIER);
            }
            case 49:
                break;
            ...
            case 50:
                break;
            case 16: {
                addToken(highlightingLess ? IToken.RESERVED_WORD
                        : IToken.IDENTIFIER);
            }
            case 51:
                break;
            ...
            case 57:
                break;
            case 12: {
                addToken(highlightingLess ? IToken.SEPARATOR
                        : IToken.IDENTIFIER);
            }
            case 58:
                break;
            ...
            case 38: {
                if (highlightingLess) {
                    ...
                    addToken(zzStartRead, zzStartRead + 1, IToken.IDENTIFIER);
                    zzStartRead = temp;
                }
            }
            case 61:
                break;
            case 5: {
                /* Unknown pseudo class */ addToken(IToken.DATA_TYPE);
            }
            case 62:
                break;
            case 23: {
            ...
            case 36: {
                addToken(
                        highlightingLess ? IToken.ANNOTATION : IToken.VARIABLE);
            }
            case 66:
                break;
            case 3: {
                addToken(highlightingLess ? IToken.LITERAL_NUMBER_DECIMAL_INT
                        : IToken.IDENTIFIER);
            }
            case 67:
                break;
            ...
            case 73:
                break;
            case 35: {
                addToken(highlightingLess ? IToken.VARIABLE : IToken.REGEX);
            }
            case 74:
                break;
            case 18: {
                addToken(
                        IToken.SEPARATOR); /* Helps with auto-closing curlies when editing CSS */
            }
            case 75:
                break;
            case 34: {
            ...
            case 79:
                break;
            case 26: {
                /* End of a function */ addToken(IToken.SEPARATOR);
            }
            case 80:
                break;
            case 41: {
                if (highlightingLess) {
                    // Unfortunately, as we're sharing the CSS and Less syntax
                    // highlighting, we do not color nested selectors properly.
                    // For uniformity, color this the same as CSS_Property
            ...
            case 39: {
                addToken(
                        highlightingLess ? IToken.VARIABLE : IToken.IDENTIFIER);
            }
            case 82:
                break;
            case 14: {
                /*System.out.println("css_property: " + yytext());*/ addToken(
                        IToken.IDENTIFIER);
            }
            case 83:
                break;
            ...
            case 90:
                break;
            case 21: {
                /*System.out.println("css_value: " + yytext());*/ addToken(
                        IToken.IDENTIFIER);
            }
            case 91:
                break;
            ...
            case 92:
                break;
            case 42: { // This must be before {CSS_Value} since "//" is a valid CSS value
                if (highlightingLess) {
                    cssPrevState = zzLexicalState;
                    start = zzMarkedPos - 2;
                    yybegin(LESS_EOL_COMMENT);
