 ...
 * at the position denoted by <code>&lt;caret&gt;</code>.
 *
 * @author D. Campione
 * @see ICodeTemplate
 * 
...
public class StaticCodeTemplate extends AbstractCodeTemplate {
    ...
    private static final long serialVersionUID = -1725977630675272271L;
    ...
    /**
     * Cached value representing whether <code>beforeCaret</code> contains one
     * or more newlines.
     */
    ...
    /**
     * Ctor. This constructor only exists to support persistance through
     * serialization.
     */
    ...
    /**
     * Returns the "after caret" text, with each new line indented by the
     * specified amount.
     *
    ...
    /**
     * Returns the "before caret" text, with each new line indented by the
     * specified amount.
     *
     * @param indent The amount to indent.
    ...
    public void invoke(SyntaxTextArea textArea) throws BadLocationException {
        ...
        // endWS is the end of the leading whitespace of the current line
        int endWS = 0;
        while (endWS < len && SyntaxUtilities.isWhitespace(s.charAt(endWS))) {
            endWS++;
        }
