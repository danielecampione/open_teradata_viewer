...
public class TokenUtils {
     ...
     *         <code>null</code> if <code>pos</code> was not a valid offset into
     *         the token list.
     * @see #getSubTokenList(IToken, int, TabExpander, SyntaxTextArea, float, TokenImpl)
     */
    public static TokenSubList getSubTokenList(IToken tokenList, int pos,
     ...
     *        result. This may be <code>null</code> but callers can pass in a
     *        "buffer" token for performance if desired.
     * @return Information about the "sub" token list. This will be
     *         <code>null</code> if <code>pos</code> was not a valid offset into
     *         the token list.
     * @see #getSubTokenList(IToken, int, TabExpander, SyntaxTextArea, float)
     */
    public static TokenSubList getSubTokenList(IToken tokenList, int pos,
            TabExpander e, final SyntaxTextArea textArea, float x0,
            TokenImpl tempToken) {
        ...
        if (t != null && t.isPaintable()) {
            if (t.getOffset() != pos) {
                ...
                x0 += t.getWidthUpTo(t.length() - difference + 1, textArea, e,
                        x0);
    ...
    public static class TokenSubList {
        ...
        /** The "sub" token list. */
        public IToken tokenList;

        /**
         * The width, in pixels, of the part of the token list "removed from the
         * front". This way, you know the x-offset of the "new" token list.
         */
        public float x;

        public TokenSubList(IToken tokenList, float x) {
