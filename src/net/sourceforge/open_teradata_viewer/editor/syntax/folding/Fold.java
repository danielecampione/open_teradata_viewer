...
public class Fold implements Comparable<Object> {
    ...
    public Fold(int type, SyntaxTextArea textArea, int startOffs)
     ...
     * STA displays the "first" line in a fold, this means that the line must
    ...
    /**
     * Returns whether the given line is in the range <code>[getStartLine(),
     * getEndLine()]</code>, inclusive.
     *
     * @param line The line to check.
     ...
     * collapsed, this method returns {@link #getLineCount()}, otherwise it
     * returns the sum of all collapsed lines of all child folds of this one.<p>
     *
     ...
     * that it's already been verified that <code>offs</code> is indeed
    ...
    /**
     * Returns the end line of this fold. For example, in languages such as C
     * and Java, this might be the line containing the closing curly brace of
     * a code block.<p>
     *
    ...
    /**
     * Returns the end offset of this fold. For example, in languages such as C
     * and Java, this might be the offset of the closing curly brace of a code
     * block.<p>
     *
     * The value returned by this method will automatically update as the text
     * area's contents are modified, to track the ending offset of the code
     * block.
     *
     ...
     * {@link IFoldType}, or a user-defined value.
     *
    ...
    /**
     * Returns the starting line of this fold region. This is the only line in
     * the fold region that is not hidden when a fold is collapsed.<p>
     *
     * The value returned by this method will automatically update as the text
     * area's contents are modified, to track the starting line of the code
     * block.
     *
     ...
     *
     * The value returned by this method will automatically update as the text
     * area's contents are modified, to track the starting offset of the code
     * block.
     *
     ...
     * {@link IFoldParser} should not remember fold regions all on a single line,
     ...
     * {@link IFoldParser} implementations if they determine that a fold is all
     ...
     * code block in C or Java. {@link IFoldParser} implementations should call
     * this on an existing <code>Fold</code> upon finding its end. If this
     * method isn't called, then this <code>Fold</code> is considered to have no
     * end, i.e., it will collapse everything to the end of the file.
     * 
