...
public class FoldManager {
     ...
     * @return The fold, or <code>null</code> if the line is not the start of a
     *         fold region.
        ...
        while (low <= high) {
            ...
            if (line == startLine) {
                ...
                if (line >= endLine) {
                    ...
                    return children != null ? getFoldForLineImpl(midFold,
                            children, line) : null;
                }
            }
        }
     ...
     *             line number of a physical line (i.e. visible, not folded),
     ...
     *                 line (i.e. visible, not code-folded), or a logical one
     *                 (i.e. any line from the model). If <code>line</code> was
     *                 determined by a raw line calculation (i.e.
     *                 <code>(visibleTopY / lineHeight)</code>), this value
     *                 should be <code>true</code>. It should be
     *                 <code>false</code> when it was calculated from an offset
     ...
     *         <code>line</code>.
     */
    private int getHiddenLineCountAboveImpl(Fold fold, int line,
            boolean physical) {
        int count = 0;
     ...
     * text area, AND folding is supported for the language it is editing.
     * Whether or not folding is supported for a language depends on whether a
     * fold parser is registered for that language with the
     ...
     * usually does not need to be called by the programmer, since fold parsing
     * is done automatically by STA.
     */
    public void reparse() {
     ...
     * support folding will ignore this property.
     *
