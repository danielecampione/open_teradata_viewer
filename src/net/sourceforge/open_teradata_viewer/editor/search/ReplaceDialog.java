 ...
 * </ul>
 * The dialog also remembers your previous several selections in a combo box.<p>
 ...
 * or
 * {@link SearchEngine#replace(net.sourceforge.open_teradata_viewer.editor.TextArea, net.sourceforge.open_teradata_viewer.editor.SearchContext) SearchEngine.replace()}
...
public class ReplaceDialog extends AbstractFindReplaceDialog {
    ...
    private static final long serialVersionUID = -9123273927971249672L;
     ...
     */
    public ReplaceDialog(Dialog owner, ISearchListener listener) {
        super(owner);
        init(listener);
    }
     ...
     * @param listener The component that listens for {@link SearchEvent}s.
     */
    public ReplaceDialog(Frame owner, ISearchListener listener) {
        super(owner);
        init(listener);
    }
    ...
    private void init(ISearchListener listener) {
        ...
        replaceFieldLabel = UIUtil.newLabel("Replace with", replaceWithCombo);
        ...
        replaceButton = UIUtil.newButton("Replace");
        ...
        replaceAllButton = UIUtil.newButton("ReplaceAll");
     ...
     *
     * @param newReplaceString The <code>String</code> to put into the replace
     *        field.
     */
    ...
    private class ReplaceDocumentListener implements DocumentListener {
        ...
        public void insertUpdate(DocumentEvent e) {
            JTextComponent findWhatTextField = UIUtil
                    .getTextComponent(findTextCombo);
