...
public interface ICompletionProvider {
    ...
    /**
     * Gets the possible completions for the text component at the current caret
     * position.
     *
     * @param comp The text component.
     ...
     *
     * @return The cell renderer, or <code>null</code> if the default should be
     *         used.
     ...
     *
     * @return The parameter choices provider, or <code>null</code> if none is
     *         installed.
     */
     ...
     * or method.
     *
     * @return The text for a parameter list end, for example, '<code>)</code>'.
     ...
     *
     * @return The text that separates parameters, for example, "<code>,
     *         </code>".
     * @see #getParameterListStart()
     ...
     * @see #setParent(ICompletionProvider)
     */
    public ICompletionProvider getParent();

    /**
     * This method is called if auto-activation is enabled in the parent {@link
     * AutoCompletion} after the user types a single character. This provider
     * should check the text at the current caret position of the text
     * component, and decide whether auto-activation would be appropriate here.
     * For example, a <code>ICompletionProvider</code> for Java might want to
     * return <code>true</code> for this method only if the last character typed
     * was a '<code>.</code>'.
     *
     * @param tc The text component.
     ...
     * (e.g. functions or methods). If this method isn't called, functions and
     * methods will not have their parameters auto-completed.
     *
     * @param listStart The character that marks the beginning of a list of
     *        parameters, such as '<tt>(</tt>' in C or Java.
     * @param separator Text that should separate parameters in a parameter list
     *        when one is inserted. For example, "<tt>, </tt>".
     ...
     *         <tt>listEnd</tt> is not printable ASCII, or if <tt>separator</tt>
     ...
     *
     * @param parent The parent provider. <code>null</code> means there will be
     *        no parent provider.
     * @see #getParent()
     */
