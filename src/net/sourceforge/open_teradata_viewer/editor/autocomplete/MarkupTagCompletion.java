...
public class MarkupTagCompletion extends AbstractCompletion {
     ...
     */
    public MarkupTagCompletion(ICompletionProvider provider, String name) {
        super(provider);
        this.name = name;
    }
     ...
     *
     * @return A list of {@link IParameterizedCompletion.Parameter}s.
    ...
    /**
     * Returns the specified {@link IParameterizedCompletion.Parameter}.
     *
