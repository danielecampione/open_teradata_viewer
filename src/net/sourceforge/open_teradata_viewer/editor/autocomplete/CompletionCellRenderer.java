 ...
 * ICompletion} types, like Eclipse and NetBeans do. Specifically, this renderer
 * handles:  
 * 
 * <ul>
...
public class CompletionCellRenderer extends DefaultListCellRenderer {
    ...
    private static final long serialVersionUID = 2533526800809961704L;
    ...
    /**
     * Whether to display the types of fields and return types of functions in
     * the completion text.
     */
    ...
    /**
     * Ctor. This is primarily a hook for Substance, or any other Look and Feel
     * whose renderers look drastically different than standard
    ...
    /**
     * Attempts to delegate rendering to a Substance cell renderer. This should
     * only be called if Substance is known to be on the classpath.
     *
    ...
    public Component getListCellRendererComponent(JList list, Object value,
        ...
        this.realBG = altBG != null && (index & 1) == 1 ? altBG : list
                .getBackground();
    ...
    /**
     * Returns whether the types of fields and return types of methods are shown
    ...
    protected void paintComponent(Graphics g) {
        ...
        if (text != null) {
            ...
            if (v != null) {
                // HTML rendering doesn't auto-center vertically
     ...
     * primarily a hook for Substance and other Look and Feels whose renderers
     * look drastically different from the standard
     ...
     *
     * @param font The font to use. If this is <code>null</code>, then the
     *        default list font is used.
     * @see #getDisplayFont()
     */
     ...
     * @see #setIconWithDefault(ICompletion, Icon)
     */
    protected void setIconWithDefault(ICompletion completion) {
     ...
     *        specify an icon.
     * @see #setIconWithDefault(ICompletion)
     */
    protected void setIconWithDefault(ICompletion completion, Icon defaultIcon) {
        Icon icon = completion.getIcon();
        setIcon(icon != null ? icon : (defaultIcon != null ? defaultIcon
                : emptyIcon));
    }
    ...
    /**
     * Sets whether the types of fields and return types of methods are shown in
     * the completion text.
     *
    ...
    /**
     * Sets the color to use for function/field types. Note that if {@link
     * #getShowTypes()} returns <code>false</code>, this property effectively
     * does nothing.
     *
