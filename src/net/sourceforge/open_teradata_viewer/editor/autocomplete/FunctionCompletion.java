...
public class FunctionCompletion extends VariableCompletion implements
     ...
     */
    public FunctionCompletion(ICompletionProvider provider, String name,
            String returnType) {
    ...
    public String getDefinitionString() {
        ...
        ICompletionProvider provider = getProvider();
     ...
     * @return The text.
     */
    private String getParamText(IParameterizedCompletion.Parameter param) {
     ...
     *
     * @param params The parameters. This should be a list of {@link
     *        IParameterizedCompletion.Parameter}s.
     * @see #getParam(int)
     * @see #getParamCount()
     */
