...
class ParameterizedCompletionInsertionInfo {
    ...
    /**
     * Returns the maximum offset the caret can move to before being outside of
    ...
    /**
     * Returns the starting - and ending - offsets of the replacement regions in
     * the completion.
     *
    ...
    /**
     * Returns the offset that should be the end of the initially selected text
     * when the completion is inserted (i.e., the end offset of the first
     * replacement region).
     *
     ...
     * text when the completion is inserted (i.e., the start offset of the first
     * replacement region).
     *
    ...
    /**
     * Sets the document range the caret can move around in before being outside
     * of the text inserted for the completion.
     *
