...
public class ChangeableHighlightPainter extends LayeredHighlighter.LayerPainter
     ...
     * like
     * <code>javax.swing.text.DefaultHighlighter.DefaultHighlightPainter</code>).
     */
     ...
     * other values (<code>[0.0f..1.0f)</code>), there will be a performance
     * hit.
     *
        ...
        try {
            ...
            if (p0.y == p1.y) {
                ...
                if ((p0.y + p0.height) != p1.y) {
                    g2d.fillRect(alloc.x, p0.y + p0.height, alloc.width, p1.y
                            - (p0.y + p0.height));
                }
    ...
    public Shape paintLayer(Graphics g, int offs0, int offs1, Shape bounds,
        ...
        if (offs0 == offs1) {
            try {
                Shape s = view
                        .modelToView(offs0, bounds, Position.Bias.Forward);
    ...
    private void readObject(ObjectInputStream s) throws ClassNotFoundException,
            IOException {
        s.defaultReadObject();
        // We cheat and always serialize the Paint as a Color. "-1" means no
        // Paint (i.e. use system selection color when painting).
        int rgb = s.readInt();
     ...
     * highlight will be. There will be a small performance hit for values less
     * than <code>1.0f</code>.
     *
    ...
    /**
     * Sets the <code>Paint</code> (usually a <code>java.awt.Color</code>) used
     * to paint this highlight.
     *
