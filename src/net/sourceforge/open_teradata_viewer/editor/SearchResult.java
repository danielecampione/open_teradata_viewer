...
public class SearchResult implements Comparable<SearchResult> {
    ...
    /**
     * If a find or replace operation is successful, this will be the range of
     * text representing the found text (for "find" operations) or the
    ...
    /** Ctor; indicates no match is found. */
    public SearchResult() {
        this(null, 0, 0);
    }
     ...
     *        operation. This can be <code>null</code> if the selection was not
     *        changed.
     * @param count The number of matches found or replaced. For regular "find"
     *        and "replace" operations, this will be zero or <code>1</code>; for
     *        "replace all" operations, this will be the number of replacements.
     ...
     * all" operations, this will be the number of replacements. For "mark all"
    ...
    public String toString() {
        return "[SearchResult: " + "count=" + getCount() + ", markedCount="
                + getMarkedCount() + ", matchRange=" + getMatchRange() + "]";
    }
