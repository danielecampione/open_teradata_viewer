...
public class JSMethodData {
    ...
    public String getParameterName(int index) {
        ...
        // specified in Javadoc and is much faster for us to fetch (it's already
        // parsed)
                ...
                if (rawSummary != null && rawSummary.startsWith("/**")) {
                    ...
                    while ((nextParam = rawSummary.indexOf("@param", offs)) > -1) {
                        ...
                        while (temp < summaryLen
                                && !Character.isJavaIdentifierPart(rawSummary
                                        .charAt(temp))
    ...
    public String getParameterType(String[] paramTypes, int index,
        ...
        if (paramTypes != null && index < paramTypes.length) {
            return ((SourceCompletionProvider) provider).getTypesFactory()
                    .convertJavaScriptType(paramTypes[index], true);
        }
        return null;
    }
        ...
        if (cu != null) {
            ...
            for (; i.hasNext();) {
                ...
                if (typeName.equals(cf.getClassName(false))) {
                    ...
                    for (Iterator<IMember> j = td.getMemberIterator(); j
                            .hasNext();) {
