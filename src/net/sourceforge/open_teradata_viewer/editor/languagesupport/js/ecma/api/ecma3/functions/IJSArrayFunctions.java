...
public interface IJSArrayFunctions extends IJSObjectFunctions {
     ...
     * </pre>
     *
     * @param separator An optional character or string used to separate each
     *        element with the string.
     ...
     * @param deletecount The number of elements starting with and including
     *        <i><b>start</b></i>.
