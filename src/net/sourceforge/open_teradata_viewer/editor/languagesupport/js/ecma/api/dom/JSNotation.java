 ...
 *
 */
public abstract class JSNotation implements Notation, IJS5ObjectFunctions {
     ...
     * @type Notation
     * @memberOf Notation
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSNotation
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
