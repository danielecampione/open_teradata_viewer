 ...
 *
 */
public abstract class JSTypeInfo implements TypeInfo, IJS5ObjectFunctions {
     ...
     * @type TypeInfo
     * @memberOf TypeInfo
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSTypeInfo
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
