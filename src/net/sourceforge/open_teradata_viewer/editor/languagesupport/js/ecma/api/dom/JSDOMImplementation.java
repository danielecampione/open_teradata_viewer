 ...
 *
 */
public abstract class JSDOMImplementation implements DOMImplementation,
        IJS5ObjectFunctions {
     ...
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSDOMImplementation
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
