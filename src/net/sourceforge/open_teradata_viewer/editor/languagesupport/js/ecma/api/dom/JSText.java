 ...
 *
 */
public abstract class JSText implements Text, IJS5ObjectFunctions {
     ...
     * @type Text
     * @memberOf Text
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSCharacterData
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
