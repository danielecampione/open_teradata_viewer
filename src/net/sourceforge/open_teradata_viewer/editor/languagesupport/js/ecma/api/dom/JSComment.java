 ...
 *
 */
public abstract class JSComment implements Comment, IJS5ObjectFunctions {
     ...
     * @type Comment
     * @memberOf Comment
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSComment
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
