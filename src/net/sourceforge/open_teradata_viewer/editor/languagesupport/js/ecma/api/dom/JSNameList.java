 ...
 *
 */
public abstract class JSNameList implements NameList, IJS5ObjectFunctions {
     ...
     * @type NameList
     * @memberOf NameList
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSNameList
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
