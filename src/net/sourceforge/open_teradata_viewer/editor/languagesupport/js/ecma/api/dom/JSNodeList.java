 ...
 *
 */
public abstract class JSNodeList implements NodeList, IJS5ObjectFunctions {
     ...
     * @type NodeList
     * @memberOf NodeList
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSNodeList
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
