 ...
 *
 */
public abstract class JSDOMLocator implements DOMLocator, IJS5ObjectFunctions {
     ...
     * @type DOMLocator
     * @memberOf DOMLocator
     * @see net.sourceforge.open_teradata_viewer.editor.languagesupport.js.ecma.api.dom.JSDOMLocator
     * @since Standard ECMA-262 3rd. Edition.
     * @since Level 2 Document Object Model Core Definition.
     */
