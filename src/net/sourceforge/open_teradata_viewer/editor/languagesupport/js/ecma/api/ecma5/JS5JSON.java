...
public abstract class JS5JSON {
     ...
     * @param <i>reviver</b> An optional argument function that can transform
     *        parsed values. 
     * @returns {Object}
     ...
     * @param <i>filter</i> An optional function that can replace values before
     *        stringification.
     * @param <i>indent</i> An optional argument that specifies am indentation
     *        string or number of spaces to use for indentation. 
