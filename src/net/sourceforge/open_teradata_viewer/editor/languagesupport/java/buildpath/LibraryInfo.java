...
/**
 * Information about a jar, compiled class folder or other source of classes to
 * add to the "build path" for Java completion. Instances of this class are
...
public abstract class LibraryInfo implements Comparable, Cloneable {
     ...
     * be <code>null</code>.
     */
    private ISourceLocation sourceLoc;
    ...
    /**
     * Readies this library for many class files being fetched via {@link
    ...
    public Object clone() {
        try {
            ...
            throw new IllegalStateException(
                    "Doesn't support cloning but should. - "
                            + getClass().getName());
        }
    }

    /**
     * Returns the class file information for the specified class. Instances of
     * <code>JarReader</code> can call this method to lazily load information on
     * individual classes and shove it into their package maps.
     * <p>
     * If many class files will be fetched at a time, you should prefer using
     * {@link #bulkClassFileCreationStart()} and {@link
     * #createClassFileBulk(String)} over this method, for performance reasons.
     *
     ...
     * @see #createClassFileBulk(String)
     */
    public abstract ClassFile createClassFile(String entryName)
            throws IOException;
     ...
     *
     * @return Whether the specified instance represents the same class source
     *         as this one.
     */
    @Override
     ...
     * <tt>classes.jar</tt>. The associated source zip/jar file is also checked
     * for.
     *
     * @return The information or <code>null</code> if there is not a JRE in the
     *         specified directory.
    ...
    /**
     * Returns the location of this library, as a string. If this library is
     * contained in a single jar file, this will be the full path to that jar.
     * If it is a directory containing classes, it will be the full path of the
     * directory. Otherwise, this value will be <code>null</code>.
     *
     ...
     * @see #setSourceLocation(ISourceLocation)
     */
     ...
     * overridden. Instances of <code>LibraryInfo</code> aren't typically stored
     * in maps, so the hash value isn't necessarily important to
     * <code>STALanguageSupport</code>.
     *
     ...
     */
    public void setSourceLocation(ISourceLocation sourceLoc) {
