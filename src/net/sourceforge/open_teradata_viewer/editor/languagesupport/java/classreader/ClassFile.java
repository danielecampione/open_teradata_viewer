...
import net.sourceforge.open_teradata_viewer.editor.languagesupport.java.classreader.attributes.SourceFile;
...
import net.sourceforge.open_teradata_viewer.editor.languagesupport.java.classreader.constantpool.ConstantPoolInfoFactory;
...
public class ClassFile implements IAccessFlags {
    ...
    /**
     * Index into {@link #constantPool} for a <code>ConstantClassInfo</code>
     * structure representing the superclass of this class or interface. If this
     * value is <code>0</code> then this class must be class
    ...
    /**
     * Structures giving complete descriptions of the fields in this class or
     * interface.
     */
    ...
    /**
     * A mapping of type parameters to type arguments. This is set via {@link
     ...
     *
     * @param cpIndex The index into the constant pool. Note that this value is
     *        <code>1</code>-based.
     ...
     * @param fullyQualified Whether the returned interface name should be fully
     *        qualified.
    ...
    /**
     * Returns information about the specified method defined/declared in this
     * class file.
     *
     ...
     * @return Any method overloads with the given name or <code>null</code> if
     *         none. This is a list of {@link MethodInfo}s.
     ...
     *
     * @param name The method name.
     * @param argCount The number of arguments. If this is less than zero, all
     *        overloads will be returned, regardless of argument count.
     * @return Any method overloads with the given name and argument count or
     *         <code>null</code> if none. This is a list of {@link MethodInfo}s.
     ...
     *
     * @return The package or <code>null</code> if this class or interface is
     *         not in a package.
     ...
     *        qualified.
     * @return The name of the superclass of this class or interface. If this is
     *         an interface, then "<code>java.lang.Object</code>" is returned.
     *         If this class file represents <code>java.lang.Object</code>, then
     ...
     * @return The type argument or "<code>Object</code>" if no type parameters
     *         have been set. This is because, if the user types, say,
     *         "<code>java.util.List list;</code>" in Java 5+, the
     *         type defaults to <code>Object</code>. The code completion API may
     *         set the type argument mapping to <code>null</code> if no type
     *         arguments are scanned, thus we need to return <code>Object</code>
     *         in this case.
     ...
     *
     * @return The class's version number, in the form <code>major.minor</code>.
     */
    ...
    private void readConstantPoolInfos(DataInputStream in) throws IOException {
        ...
        for (int i = 0; i < constantPoolCount; i++) {
            ConstantPoolInfo cpi = ConstantPoolInfoFactory
                    .readConstantPoolInfo(this, in);
            constantPool[i] = cpi;
    ...
    /**
     * Sets a mapping of type parameters of this class to type arguments for a
     * particular instance of this class. Note that <code>ClassFile</code> does
     * not directly use this field; it is there for code completion API's to use
     * to extract the necessary types of arguments, return values, etc.., of
     * methods (see the {@link MethodInfo} class).
     *
    ...
    public String toString() {
        return "[ClassFile: " + "accessFlags=" + accessFlags + "]";
    }
}