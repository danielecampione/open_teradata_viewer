 ...
 * 
 */
class SourceCodeScanner implements ITokenTypes {
    ...
    private static final String ZZ_CMAP_PACKED = "\11\10\1\4\1\3\1\0\1\4\1\3\16\10\4\0\1\4\1\67"
    ...
    private static final String ZZ_ACTION_PACKED_0 = "\1\0\1\1\1\2\1\3\1\4\1\5\2\6\1\7"
            ...
            + "\1\2\1\153\2\2\1\154\1\2\1\155\1\156\1\2" + "\1\157";
    ...
    private static final String ZZ_TRANS_PACKED_0 = "\2\2\1\3\2\4\1\5\1\6\1\3\1\2\1\3"
            ...
            + "\1\3\4\0\10\3\1\0\10\3\2\0\3\3\1\0" + "\5\3\1\u0155\10\3\25\0";
    ...
    private static final String ZZ_ATTRIBUTE_PACKED_0 = "\1\0\1\11\22\1\1\11\7\1\10\11\4\1\3\11"
    ...
    private IJavaLexicalToken createToken(int type) {
        return createToken(type, false);
    }

    private IJavaLexicalToken createToken(int type, boolean invalid) {
     ...
     * returns.
     *
     * @return The last documentation comment parsed or <code>null</code> if the
     *         feature is disabled.
     ...
     * @exception   java.io.IOException if any I/O-Error occurs.
     */
    public net.sourceforge.open_teradata_viewer.editor.languagesupport.java.jc.lexer.IJavaLexicalToken yylex()
            throws IOException {
        int zzInput;
        int zzAction;
        ...
        while (true) {
            ...
            case 3: {
                if (returnWhitespace) {
                    return createToken(IJavaLexicalToken.WHITESPACE);
                }
            }
            case 143:
                break;
            ...
            case 32: {
                if (returnComments) {
                    return createToken(IJavaLexicalToken.COMMENT);
                }
            }
            case 157:
                break;
            ...
            case 86: {
                ...
                if (returnComments) {
                    return createToken(IJavaLexicalToken.DOC_COMMENT);
                }
            }
            case 221:
                break;
